...
type SetVCScopeConfigReq struct {
	...
	ScopeType   int64                           `json:"scope_type,omitempty"`   // 查询节点范围示例值: 1可选值有: 会议室层级会议室
	ScopeID     string                          `json:"scope_id,omitempty"`     // 查询节点ID: 如果scope_type为1, 则为层级ID, 如果scope_type为2, 则为会议室ID示例值: "omm_608d34d82d531b27fa993902d350a307"
...
type SetVCScopeConfigReqScopeConfigRoomBoxDigitalSignageMaterial struct {
	...
	Cover        *string `json:"cover,omitempty"`         // 素材封面url示例值: "url"
	Md5          *string `json:"md5,omitempty"`           // 素材文件md5示例值: "md5"
	Vid          *string `json:"vid,omitempty"`           // 素材文件vid示例值: "v039b2g10000ca89uj3c77u5pfdkfvpg"
	Size         *string `json:"size,omitempty"`          // 素材文件大小（单位byte）示例值: "100"
}
