...
// new doc: https://open.feishu.cn/document/lingo-v1/entity/search
...
type SearchLingoEntityReq struct {
	PageSize             *int64                                    `query:"page_size" json:"-"`             // 每页返回的词条量示例值: 20默认值: `20` 取值范围: `1` ～ `100`
	PageToken            *string                                   `query:"page_token" json:"-"`            // 分页标记, 第一次请求不填, 表示从头开始遍历；分页查询结果还有更多项时会同时返回新的 page_token, 下次遍历可采用该 page_token 获取查询结果示例值: b152fa6e6f62a291019a04c3a93f365f8ac641910506ff15ff4cad6534e087cb4ed8fa2c
	...
	Query                *string                                   `json:"query,omitempty"`                 // 搜索关键词示例值: "飞书词典" 长度范围: `1` ～ `100` 字符
