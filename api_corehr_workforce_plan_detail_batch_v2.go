...
// BatchQueryCoreHRWorkforcePlanDetailV2 查询编制规划明细, 包括维度信息、编制数、预估在职人数、在职人数和预增/预减人数。
//
// - 本接口可查询编制规划或集中填报明细信息。
...
func (r *CoreHRService) BatchQueryCoreHRWorkforcePlanDetailV2(ctx context.Context, request *BatchQueryCoreHRWorkforcePlanDetailV2Req, options ...MethodOptionFunc) (*BatchQueryCoreHRWorkforcePlanDetailV2Resp, *Response, error) {
	if r.cli.mock.mockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2 != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] CoreHR#BatchQueryCoreHRWorkforcePlanDetailV2 mock enable")
		return r.cli.mock.mockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2(ctx, request, options...)
	}
	...
	resp := new(batchQueryCoreHRWorkforcePlanDetailV2Resp)

	response, err := r.cli.RawRequest(ctx, req, resp)
	return resp.Data, response, err
}

// MockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2 mock CoreHRBatchQueryCoreHRWorkforcePlanDetailV2 method
func (r *Mock) MockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2(f func(ctx context.Context, request *BatchQueryCoreHRWorkforcePlanDetailV2Req, options ...MethodOptionFunc) (*BatchQueryCoreHRWorkforcePlanDetailV2Resp, *Response, error)) {
	r.mockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2 = f
}

// UnMockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2 un-mock CoreHRBatchQueryCoreHRWorkforcePlanDetailV2 method
func (r *Mock) UnMockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2() {
	r.mockCoreHRBatchQueryCoreHRWorkforcePlanDetailV2 = nil
}

// BatchQueryCoreHRWorkforcePlanDetailV2Req ...
type BatchQueryCoreHRWorkforcePlanDetailV2Req struct {
	...
	DimensionIDInDatas            []*BatchQueryCoreHRWorkforcePlanDetailV2ReqDimensionIDInData `json:"dimension_id_in_datas,omitempty"`            // 维度筛选 长度范围: `0` ～ `100`
...
// BatchQueryCoreHRWorkforcePlanDetailV2ReqDimensionIDInData ...
type BatchQueryCoreHRWorkforcePlanDetailV2ReqDimensionIDInData struct {
...
// BatchQueryCoreHRWorkforcePlanDetailV2Resp ...
type BatchQueryCoreHRWorkforcePlanDetailV2Resp struct {
	...
	Items                         []*BatchQueryCoreHRWorkforcePlanDetailV2RespItem `json:"items,omitempty"`                            // 编制规划明细信息
	PageToken                     string                                           `json:"page_token,omitempty"`                       // 分页标记, 当 has_more 为 true 时, 会同时返回新的 page_token, 否则不返回 page_token
	HasMore                       bool                                             `json:"has_more,omitempty"`                         // 是否还有更多项
}

// BatchQueryCoreHRWorkforcePlanDetailV2RespItem ...
type BatchQueryCoreHRWorkforcePlanDetailV2RespItem struct {
	WorkforcePlanDetailID             string                                                                           `json:"workforce_plan_detail_id,omitempty"`             // 编制规划明细 ID
	DimensionInfoDatas                []*BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoData                `json:"dimension_info_datas,omitempty"`                 // 维度信息
	...
	EstimatedActiveIndividualsDetails []*BatchQueryCoreHRWorkforcePlanDetailV2RespItemEstimatedActiveIndividualsDetail `json:"estimated_active_individuals_details,omitempty"` // 预估在职人数明细
	MultiPeriodValues                 []*BatchQueryCoreHRWorkforcePlanDetailV2RespItemMultiPeriodValue                 `json:"multi_period_values,omitempty"`                  // 自然周期的编制规划信息。功能灰度中, 有需要请联系[技术支持](https://applink.feishu.cn/TLJpeNdW)
...
// BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoData ...
type BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoData struct {
	...
	DimensionInfo *BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoDataDimensionInfo `json:"dimension_info,omitempty"` // 维度信息
}

// BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoDataDimensionInfo ...
type BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoDataDimensionInfo struct {
	...
	Name []*BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoDataDimensionInfoName `json:"name,omitempty"` // 维度名称
}

// BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoDataDimensionInfoName ...
type BatchQueryCoreHRWorkforcePlanDetailV2RespItemDimensionInfoDataDimensionInfoName struct {
	Lang  string `json:"lang,omitempty"`  // 语言编码（IETF BCP 47）
	Value string `json:"value,omitempty"` // 文本内容
}

// BatchQueryCoreHRWorkforcePlanDetailV2RespItemEstimatedActiveIndividualsDetail ...
type BatchQueryCoreHRWorkforcePlanDetailV2RespItemEstimatedActiveIndividualsDetail struct {
...
type BatchQueryCoreHRWorkforcePlanDetailV2RespItemMultiPeriodValue struct {
...
type batchQueryCoreHRWorkforcePlanDetailV2Resp struct {
	...
	Data  *BatchQueryCoreHRWorkforcePlanDetailV2Resp `json:"data,omitempty"`
