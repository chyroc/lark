...
type UpdateDriveFileSubscriptionReq struct {
	...
	SubscriptionID string   `path:"subscription_id" json:"-"` // 订阅关系ID示例值: "1234567890987654321"
	IsSubscribe    bool     `json:"is_subscribe,omitempty"`   // 是否订阅示例值: true
	FileType       FileType `json:"file_type,omitempty"`      // 文档类型示例值: "docx"可选值有: 文档新版文档知识库wiki
}
