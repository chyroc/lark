...
type GetContactGroupMemberReq struct {
	...
	MemberIDType *IDType `query:"member_id_type" json:"-"` // 欲获取成员ID类型。,当member_type=user时候，member_id_type表示user_id_type，枚举值open_id, union_id和user_id。,当member_type=department时候，member_id_type表示department_id_type，枚举值open_id和department_id。, 示例值："open_id", 可选值有: ,<md-enum>,<md-enum-item key="open_id" >member_type =user时候，表示用户的open_id</md-enum-item>,<md-enum-item key="union_id" >member_type =user时候，表示用户的union_id</md-enum-item>,<md-enum-item key="user_id" >member_type =user时候，表示用户的user_id</md-enum-item>,<md-enum-item key="department_id" >member_type=department时候，表示部门的department_id</md-enum-item>,</md-enum>, 默认值: `open_id`
	MemberType   *string `query:"member_type" json:"-"`    // 欲获取的用户组成员类型。, 示例值："user", 可选值有: ,<md-enum>,<md-enum-item key="user" >用户。返回归属于该用户组的用户列表</md-enum-item>,<md-enum-item key="department" >部门。返回归属于该用户组的部门列表</md-enum-item>,</md-enum>, 默认值: `user`
