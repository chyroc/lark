...
// new doc: https://open.feishu.cn/document/im-v1/message/push_follow_up
func (r *MessageService) CreateIMMessagePushFollowUp(ctx context.Context, request *CreateIMMessagePushFollowUpReq, options ...MethodOptionFunc) (*CreateIMMessagePushFollowUpResp, *Response, error) {
	if r.cli.mock.mockMessageCreateIMMessagePushFollowUp != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] Message#CreateIMMessagePushFollowUp mock enable")
		return r.cli.mock.mockMessageCreateIMMessagePushFollowUp(ctx, request, options...)
	}
...
// MockMessageCreateIMMessagePushFollowUp mock MessageCreateIMMessagePushFollowUp method
func (r *Mock) MockMessageCreateIMMessagePushFollowUp(f func(ctx context.Context, request *CreateIMMessagePushFollowUpReq, options ...MethodOptionFunc) (*CreateIMMessagePushFollowUpResp, *Response, error)) {
	r.mockMessageCreateIMMessagePushFollowUp = f
}

// UnMockMessageCreateIMMessagePushFollowUp un-mock MessageCreateIMMessagePushFollowUp method
func (r *Mock) UnMockMessageCreateIMMessagePushFollowUp() {
	r.mockMessageCreateIMMessagePushFollowUp = nil
}
