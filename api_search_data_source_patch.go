...
type UpdateSearchDataSourceReq struct {
	...
	Name            *string                                   `json:"name,omitempty"`             // 数据源的展示名称示例值: "客服工单"
	State           *int64                                    `json:"state,omitempty"`            // 数据源状态, 0-已上线, 1-未上线示例值: 0可选值有: 已上线未上线
	Description     *string                                   `json:"description,omitempty"`      // 对于数据源的描述示例值: "搜索客服工单"
	IconURL         *string                                   `json:"icon_url,omitempty"`         // 数据源在 search tab 上的展示图标路径示例值: "https://www.xxx.com/open.jpg"
