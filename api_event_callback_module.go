...
const (
	...
	EventTypeV1LeaveApprovalRevert                             EventType = "leave_approval"
...
func (r *EventCallbackService) handlerEvent(ctx context.Context, req *eventReq) (handled bool, s string, err error) {
	...
	case req.eventV1TripApproval != nil:
		if r.cli.eventHandler.eventV1TripApprovalHandler != nil {
			if r.cli.noBlocking {
				go r.cli.eventHandler.eventV1TripApprovalHandler(ctx, r.cli, req.Schema, req.headerV1(EventTypeV1TripApproval), req.eventV1TripApproval)
			} else {
