...
const (
	...
	EventTypeV2HireEHRImportTaskImportedV1                     EventType = "hire.ehr_import_task.imported_v1"
...
func (r *eventHandler) clone() *eventHandler {
	return &eventHandler{
		eventTestHandler:                                              r.eventTestHandler,
...
func (r *EventCallbackService) handlerEvent(ctx context.Context, req *eventReq) (handled bool, s string, err error) {
	switch {
	case req.eventTest != nil:
		if r.cli.eventHandler.eventTestHandler != nil {
			if r.cli.noBlocking {
				go r.cli.eventHandler.eventTestHandler(ctx, r.cli, req.Schema, req.headerV1(EventTypeTest), req.eventTest)
			} else {
				s, err = r.cli.eventHandler.eventTestHandler(ctx, r.cli, req.Schema, req.headerV1(EventTypeTest), req.eventTest)
			}
		}
		return true, s, err
