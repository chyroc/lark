...
type (
	...
	AuthenService                struct{ cli *Lark }
	BaikeService                 struct{ cli *Lark }
	BaseService                  struct{ cli *Lark }
	BitableService               struct{ cli *Lark }
	BoardService                 struct{ cli *Lark }
	BotService                   struct{ cli *Lark }
	CalendarService              struct{ cli *Lark }
	CardkitService               struct{ cli *Lark }
	CcmDocsService               struct{ cli *Lark }
	ChatService                  struct{ cli *Lark }
	CompensationService          struct{ cli *Lark }
	ContactService               struct{ cli *Lark }
	CoreHRService                struct{ cli *Lark }
	CorehrService                struct{ cli *Lark }
	DirectoryService             struct{ cli *Lark }
	DocsService                  struct{ cli *Lark }
	DocxService                  struct{ cli *Lark }
	...
	MomentsService               struct{ cli *Lark }
	OKRService                   struct{ cli *Lark }
	PassportService              struct{ cli *Lark }
	PayrollService               struct{ cli *Lark }
