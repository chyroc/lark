...
type UpdateCoreHRJobDataReq struct {
	...
	VersionID                *string                                      `json:"version_id,omitempty"`                  // 任职记录版本 ID, ID 不为空时, 将更新指定版本的任职记录内容, ID 为空时, 将新增一个版本, 示例值: "6890452208593372697"
	...
	AssignmentStartReason    *UpdateCoreHRJobDataReqAssignmentStartReason `json:"assignment_start_reason,omitempty"`     // 任职原因, 枚举值可通过文档[飞书人事枚举常量](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant) 任职原因（assignment_start_reason）枚举定义部分获得。请注意, 「任职原因」不允许填写为「onboarding」, 当上一个任职版本的「任职原因」为「onboarding」时, 「任职原因」必填, 示例值: onboarding
	...
	WorkShift                *UpdateCoreHRJobDataReqWorkShift             `json:"work_shift,omitempty"`                  // 排班类型
	CompensationType         *UpdateCoreHRJobDataReqCompensationType      `json:"compensation_type,omitempty"`           // 薪资类型
...
type UpdateCoreHRJobDataRespJobData struct {
	...
	WorkShift                *UpdateCoreHRJobDataRespJobDataWorkShift             `json:"work_shift,omitempty"`                  // 排班类型, 字段权限要求: 获取排班信息
	CompensationType         *UpdateCoreHRJobDataRespJobDataCompensationType      `json:"compensation_type,omitempty"`           // 薪资类型, 字段权限要求: 获取薪资类型
