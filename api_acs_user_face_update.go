...
type UpdateACSUserFaceReq struct {
	...
	Files      io.Reader `json:"files,omitempty"`        // 人脸图片内容示例值: jpg图片
	FileType   FileType  `json:"file_type,omitempty"`    // 文件类型, 可选的类型有jpg, png示例值: "jpg"
	FileName   string    `json:"file_name,omitempty"`    // 带后缀的文件名示例值: "efeqz12f.jpg"
}
