...
type Mock struct {
	...
	mockMDMCreateMDMUserAuthDataRelationBind                   func(ctx context.Context, request *CreateMDMUserAuthDataRelationBindReq, options ...MethodOptionFunc) (*CreateMDMUserAuthDataRelationBindResp, *Response, error)
	mockMDMCreateMDMUserAuthDataRelationUnbind                 func(ctx context.Context, request *CreateMDMUserAuthDataRelationUnbindReq, options ...MethodOptionFunc) (*CreateMDMUserAuthDataRelationUnbindResp, *Response, error)
