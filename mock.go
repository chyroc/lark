...
type Mock struct {
	...
	mockDriveDeleteDriveDocFile                          func(ctx context.Context, request *DeleteDriveDocFileReq, options ...MethodOptionFunc) (*DeleteDriveDocFileResp, *Response, error)
	...
	mockApplicationGetApplicationUsageDetail             func(ctx context.Context, request *GetApplicationUsageDetailReq, options ...MethodOptionFunc) (*GetApplicationUsageDetailResp, *Response, error)
	mockApplicationGetApplicationMessageOverview         func(ctx context.Context, request *GetApplicationMessageOverviewReq, options ...MethodOptionFunc) (*GetApplicationMessageOverviewResp, *Response, error)
	mockApplicationGetApplicationMessageTrend            func(ctx context.Context, request *GetApplicationMessageTrendReq, options ...MethodOptionFunc) (*GetApplicationMessageTrendResp, *Response, error)
	mockApplicationGetApplicationMessageDetail           func(ctx context.Context, request *GetApplicationMessageDetailReq, options ...MethodOptionFunc) (*GetApplicationMessageDetailResp, *Response, error)
	...
	mockMailCreateMailUserAlias                          func(ctx context.Context, request *CreateMailUserAliasReq, options ...MethodOptionFunc) (*CreateMailUserAliasResp, *Response, error)
	mockMailDeleteMailUserAlias                          func(ctx context.Context, request *DeleteMailUserAliasReq, options ...MethodOptionFunc) (*DeleteMailUserAliasResp, *Response, error)
	mockMailGetMailUserAliasList                         func(ctx context.Context, request *GetMailUserAliasListReq, options ...MethodOptionFunc) (*GetMailUserAliasListResp, *Response, error)
	...
	mockAttendanceQueryAttendanceUserSettings            func(ctx context.Context, request *QueryAttendanceUserSettingsReq, options ...MethodOptionFunc) (*QueryAttendanceUserSettingsResp, *Response, error)
	mockAttendanceUpdateAttendanceUserSettings           func(ctx context.Context, request *UpdateAttendanceUserSettingsReq, options ...MethodOptionFunc) (*UpdateAttendanceUserSettingsResp, *Response, error)
	mockAttendanceCreateUpdateAttendanceGroup            func(ctx context.Context, request *CreateUpdateAttendanceGroupReq, options ...MethodOptionFunc) (*CreateUpdateAttendanceGroupResp, *Response, error)
	...
	mockAttendanceGetAttendanceShiftByID                 func(ctx context.Context, request *GetAttendanceShiftByIDReq, options ...MethodOptionFunc) (*GetAttendanceShiftByIDResp, *Response, error)
	mockAttendanceGetAttendanceShiftByName               func(ctx context.Context, request *GetAttendanceShiftByNameReq, options ...MethodOptionFunc) (*GetAttendanceShiftByNameResp, *Response, error)
	mockAttendanceGetAttendanceStatisticsData            func(ctx context.Context, request *GetAttendanceStatisticsDataReq, options ...MethodOptionFunc) (*GetAttendanceStatisticsDataResp, *Response, error)
	mockAttendanceGetAttendanceStatisticsHeader          func(ctx context.Context, request *GetAttendanceStatisticsHeaderReq, options ...MethodOptionFunc) (*GetAttendanceStatisticsHeaderResp, *Response, error)
	mockAttendanceUpdateAttendanceUserStatisticsSettings func(ctx context.Context, request *UpdateAttendanceUserStatisticsSettingsReq, options ...MethodOptionFunc) (*UpdateAttendanceUserStatisticsSettingsResp, *Response, error)
	mockAttendanceGetAttendanceUserStatisticsSettings    func(ctx context.Context, request *GetAttendanceUserStatisticsSettingsReq, options ...MethodOptionFunc) (*GetAttendanceUserStatisticsSettingsResp, *Response, error)
	...
	mockAttendanceCreateUpdateAttendanceUserDailyShift   func(ctx context.Context, request *CreateUpdateAttendanceUserDailyShiftReq, options ...MethodOptionFunc) (*CreateUpdateAttendanceUserDailyShiftResp, *Response, error)
