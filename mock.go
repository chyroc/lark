...
type Mock struct {
	...
	mockCoreHRQueryCorehrApprovalGroupsDepartmentChangeListByIDs func(ctx context.Context, request *QueryCorehrApprovalGroupsDepartmentChangeListByIDsReq, options ...MethodOptionFunc) (*QueryCorehrApprovalGroupsDepartmentChangeListByIDsResp, *Response, error)
	mockCoreHRQueryCorehrApprovalGroupsJobChangeListByIDs        func(ctx context.Context, request *QueryCorehrApprovalGroupsJobChangeListByIDsReq, options ...MethodOptionFunc) (*QueryCorehrApprovalGroupsJobChangeListByIDsResp, *Response, error)
	...
	mockCoreHRQueryCorehrApprovalGroupsPositionChangeListByIDs   func(ctx context.Context, request *QueryCorehrApprovalGroupsPositionChangeListByIDsReq, options ...MethodOptionFunc) (*QueryCorehrApprovalGroupsPositionChangeListByIDsResp, *Response, error)
	mockDriveBatchUpdateDocxChatAnnouncementBlock                func(ctx context.Context, request *BatchUpdateDocxChatAnnouncementBlockReq, options ...MethodOptionFunc) (*BatchUpdateDocxChatAnnouncementBlockResp, *Response, error)
	mockDriveCreateDocxChatAnnouncementBlockChildren             func(ctx context.Context, request *CreateDocxChatAnnouncementBlockChildrenReq, options ...MethodOptionFunc) (*CreateDocxChatAnnouncementBlockChildrenResp, *Response, error)
	mockDriveBatchUpdateDocxDocumentBlock                        func(ctx context.Context, request *BatchUpdateDocxDocumentBlockReq, options ...MethodOptionFunc) (*BatchUpdateDocxDocumentBlockResp, *Response, error)
	mockDriveCreateDocxDocumentBlockDescendant                   func(ctx context.Context, request *CreateDocxDocumentBlockDescendantReq, options ...MethodOptionFunc) (*CreateDocxDocumentBlockDescendantResp, *Response, error)
