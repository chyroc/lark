...
type AdminResetPasswordReq struct {
	...
	Password   *AdminResetPasswordReqPassword `json:"password,omitempty"`     // 需要重置的密码参数, 不少于8个字符, 字母、数字和符号, 至少三选二示例值: 1234abcd
	UserID     string                         `json:"user_id,omitempty"`      // 待修改密码的用户ID, 只针对邮箱登录凭证与企业邮箱(包括别名)相等的用户生效示例值: "abc123" 长度范围: `0` ～ `200` 字符
}

// AdminResetPasswordReqPassword ...
type AdminResetPasswordReqPassword struct {
	EntEmailPassword string `json:"ent_email_password,omitempty"` // 企业邮箱密码示例值: "abcd*efg"
}
