...
// new doc: https://open.feishu.cn/document/directory-v1/employee/create
...
// CreateDirectoryEmployeeReqEmployeeEmployeeOrderInDepartment ...
type CreateDirectoryEmployeeReqEmployeeEmployeeOrderInDepartment struct {
	DepartmentID               *string `json:"department_id,omitempty"`                 // 指定员工所在的部门, 标识企业内一个唯一的部门, 与department_id_type类型保持一致。示例值: "eeddjisdwe"
	OrderWeightInDeparment     *string `json:"order_weight_in_deparment,omitempty"`     // 员工在部门内的排序权重。示例值: "100"
	OrderWeightAmongDeparments *string `json:"order_weight_among_deparments,omitempty"` // 该部门在用户所属的多个部门间的排序权重。示例值: "20"
