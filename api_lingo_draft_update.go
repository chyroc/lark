...
// new doc: https://open.feishu.cn/document/lingo-v1/draft/update
...
type UpdateLingoDraftReqRelatedMetaChat struct {
	ID string `json:"id,omitempty"` // 数据 id示例值: "格式请看请求体示例"
}

// UpdateLingoDraftReqRelatedMetaClassification ...
type UpdateLingoDraftReqRelatedMetaClassification struct {
	ID       string  `json:"id,omitempty"`        // 二级分类 ID示例值: "70496069267***37761"
	FatherID *string `json:"father_id,omitempty"` // 对应一级分类 ID示例值: "7049606926702837777"
}
