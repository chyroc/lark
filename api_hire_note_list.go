...
type GetHireNoteListReq struct {
	PageSize   *int64  `query:"page_size" json:"-"`    // 分页大小, 默认 10, 最大值为 200示例值: 10
	...
	TalentID   string  `query:"talent_id" json:"-"`    // 人才ID, 可通过[获取人才列表](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/list)获取示例值: 6916472453069883661
