...
// new doc: https://open.feishu.cn/document/trust_party-v1/-collaboraiton-organization/list-3
...
// ListDirectoryCollborationShareEntityRespShareDepartment ...
type ListDirectoryCollborationShareEntityRespShareDepartment struct {
	OpenDepartmentID string                                                       `json:"open_department_id,omitempty"` // 部门open ID
	Name             *ListDirectoryCollborationShareEntityRespShareDepartmentName `json:"name,omitempty"`               // i18n文本
}

// ListDirectoryCollborationShareEntityRespShareDepartmentName ...
type ListDirectoryCollborationShareEntityRespShareDepartmentName struct {
