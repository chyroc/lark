...
// new doc: https://open.feishu.cn/document/aily-v1/aily_session-aily_message/create
...
// CreateAilySessionAilyMessageReqMention ...
type CreateAilySessionAilyMessageReqMention struct {
	EntityID         *string `json:"entity_id,omitempty"`         // 实体 ID示例值: "ou_5ad573a6411d72b8305fda3a9c15c70e" 长度范围: `0` ～ `64` 字符
	IdentityProvider *string `json:"identity_provider,omitempty"` // 身份提供者示例值: "FEISHU"可选值有: Aily 账号体系飞书账号体系
	Key              *string `json:"key,omitempty"`               // 被@实体在消息体中的占位符示例值: "@_user_1" 长度范围: `0` ～ `32` 字符
	Name             *string `json:"name,omitempty"`              // 被@实体的名称示例值: "张三" 长度范围: `0` ～ `32` 字符
	AilyID           *string `json:"aily_id,omitempty"`           // 飞书智能伙伴创建平台账号体系下的 ID示例值: "1794840334557292" 长度范围: `0` ～ `20` 字符
}
...
// CreateAilySessionAilyMessageRespMessageMention ...
type CreateAilySessionAilyMessageRespMessageMention struct {
	EntityID         string `json:"entity_id,omitempty"`         // 实体 ID
	IdentityProvider string `json:"identity_provider,omitempty"` // 身份提供者可选值有: Aily 账号体系飞书账号体系
...
// CreateAilySessionAilyMessageRespMessageSender ...
type CreateAilySessionAilyMessageRespMessageSender struct {
	EntityID         string `json:"entity_id,omitempty"`         // 实体 ID
	IdentityProvider string `json:"identity_provider,omitempty"` // 身份提供者可选值有: Aily 账号体系飞书账号体系
	SenderType       string `json:"sender_type,omitempty"`       // 发送人类型可选值有: 用户应用
	AilyID           string `json:"aily_id,omitempty"`           // 飞书智能伙伴创建平台账号体系下的 ID
}
