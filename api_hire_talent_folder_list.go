...
// GetHireTalentFolderList 获取招聘系统中人才文件夹信息列表, 包括文件夹 ID、文件夹名称、文件夹所有者 ID。
//
...
type GetHireTalentFolderListRespItem struct {
	...
	FolderName string `json:"folder_name,omitempty"` // 文件夹名字
	OwnerID    string `json:"owner_id,omitempty"`    // 所有者 ID, 与查询参数中user_id_type的类型一致
}
