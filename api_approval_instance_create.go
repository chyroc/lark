...
type CreateApprovalInstanceReq struct {
	ApprovalCode           string                                             `json:"approval_code"`                        // 审批定义 code, 示例值: "7C468A54-8745-2245-9675-08B7C63E7A85"
	...
	Form                   ApprovalWidgetList                                 `json:"form"`                                 // json 数组, 控件值, 示例值: "[{\"id\":\"111\", \"type\": \"input\", \"value\":\"test\"}]"
...
type CreateApprovalInstanceReqI18nResource struct {
	...
	Texts     []*CreateApprovalInstanceReqI18nResourceText `json:"texts"`      // 文案 key, value, i18n key 以 @i18n@ 开头； 该字段主要用于做国际化, 允许用户同时传多个语言的文案, 审批中心会根据用户当前的语音环境使用对应的文案, 如果没有传用户当前的语音环境文案, 则会使用默认的语言文案, 示例值: { "@i18n@1": "权限申请", "@i18n@2": "OA审批", "@i18n@3": "Permission" }
