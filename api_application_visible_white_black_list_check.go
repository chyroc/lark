...
type CheckApplicationVisibleWhiteBlackListReq struct {
	AppID            string            `path:"app_id" json:"-"`              // 应用的 AppID, 可以在[开发者后台](https://open.feishu.cn/app) > 凭证与基础信息页查看。 * 仅查询本应用信息时, 可填应用自身AppID。 * 当值为其他应用的App ID时, 必须申请以下权限: 获取应用信息示例值: "cli_a3axxx01b"
	...
	DepartmentIDType *DepartmentIDType `query:"department_id_type" json:"-"` // 部门ID类型示例值: department_id可选值有: 以自定义department_id来标识部门以open_department_id来标识部门默认值: `department_id`
