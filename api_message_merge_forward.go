...
// MergeForwardMessage 将来自同一个群聊中的多条消息合并转发给指定用户或群聊。
//
// 注意事项:
...
type MergeForwardMessageReq struct {
	...
	MessageIDList []string `json:"message_id_list,omitempty"` // 要转发的消息ID列表, 详情参见[消息ID说明](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/intro#ac79c1c2), 示例值: ["om_d862083dd13b61cc009e66c40a0f0a56"], 长度范围: `1` ～ `100`
}
