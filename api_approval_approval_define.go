...
type CreateApprovalReq struct {
	DepartmentIDType *DepartmentIDType                `query:"department_id_type" json:"-"` // 此次调用中使用的部门ID的类型, 示例值: "open_department_id", 可选值有: <md-enum>, <md-enum-item key="department_id" >以自定义department_id来标识部门</md-enum-item>, <md-enum-item key="open_department_id" >以open_department_id来标识部门</md-enum-item>, </md-enum>
...
type CreateApprovalReqNode struct {
	...
	NodeType       *string                              `json:"node_type,omitempty"`       // 审批类型枚举, 当 node_type 为依次审批时, 审批人必须为『发起人自选』, 示例值: "AND", 可选值有: <md-enum>, <md-enum-item key="AND" >会签</md-enum-item>, <md-enum-item key="OR" >或签</md-enum-item>, <md-enum-item key="SEQUENTIAL" >依次审批</md-enum-item>, </md-enum>
