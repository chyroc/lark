...
type UpdateCoreHRNationalIDTypeReq struct {
	NationalIDTypeID          string                                                    `path:"national_id_type_id" json:"-"`          // 证件类型ID示例值: "1616161616"
	...
	CustomFields              []*UpdateCoreHRNationalIDTypeReqCustomField               `json:"custom_fields,omitempty"`               // 自定义字段（暂不支持）
}
...
type UpdateCoreHRNationalIDTypeRespNationalIDType struct {
	...
	CustomFields              []*UpdateCoreHRNationalIDTypeRespNationalIDTypeCustomField               `json:"custom_fields,omitempty"`               // 自定义字段（暂不支持）
}
