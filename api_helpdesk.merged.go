...
// GetHelpdeskTicketCustomizedFieldsResp ...
type GetHelpdeskTicketCustomizedFieldsResp struct {
	UserCustomizedFields   []*GetHelpdeskTicketCustomizedFieldsRespUserCustomizedField   `json:"user_customized_fields,omitempty"`   // user customized fields
	TicketCustomizedFields []*GetHelpdeskTicketCustomizedFieldsRespTicketCustomizedField `json:"ticket_customized_fields,omitempty"` // ticket customized fields
}
...
type GetHelpdeskTicketCustomizedFieldsRespUserCustomizedField struct {
	UserCustomizedFieldID string `json:"user_customized_field_id,omitempty"` // user customized field id
	ID                    string `json:"id,omitempty"`                       // user customized field id, for backward compatibility
	HelpdeskID            string `json:"helpdesk_id,omitempty"`              // help desk id
	KeyName               string `json:"key_name,omitempty"`                 // key name
	DisplayName           string `json:"display_name,omitempty"`             // display name
	Position              string `json:"position,omitempty"`                 // the position of user customized field in the page
