...
type GetCoreHrbpListReq struct {
	PageSize         int64             `query:"page_size" json:"-"`          // 分页大小, 最大 500, 示例值: 500, 取值范围: `1` ～ `500`
...
type GetCoreHrbpListRespItem struct {
	...
	HrbpID       string `json:"hrbp_id,omitempty"`       // 部门 HRBP 的雇佣 ID, 不包括上级部门的 HRBP
}
