...
// 获取动态订阅需要该清单的读取权限。
//
// doc: https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/task-v2/tasklist-activity_subscription/get
// new doc: https://open.feishu.cn/document/task-v2/tasklist-activity_subscription/get
