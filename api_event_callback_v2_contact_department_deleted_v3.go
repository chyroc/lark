...
// EventV2ContactDepartmentDeletedV3 订阅这一事件可以获得被删除部门的信息。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=department&event=deleted)
//
...
type EventV2ContactDepartmentDeletedV3Object struct {
	...
	DepartmentHrbps    []*EventV2ContactDepartmentDeletedV3ObjectDepartmentHrbp `json:"department_hrbps,omitempty"`     // 部门HRBP, 字段权限要求: 查询部门HRBP信息
}
