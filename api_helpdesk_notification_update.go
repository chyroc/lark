...
type UpdateHelpdeskNotificationReq struct {
	...
	CreateUser                  *UpdateHelpdeskNotificationReqCreateUser                `json:"create_user,omitempty"`                     // 非必填, 创建人, 示例值: {"avatar_url":"", "name":"", "user_id":"ou_7277fd1262bfafc363d5b2a1f9c2ac90"}
	CreatedAt                   *string                                                 `json:"created_at,omitempty"`                      // 非必填, 创建时间（毫秒时间戳）, 示例值: "1626332244719"
	UpdateUser                  *UpdateHelpdeskNotificationReqUpdateUser                `json:"update_user,omitempty"`                     // 非必填, 更新用户, 示例值: {"avatar_url":"", "name":"", "user_id":"ou_7277fd1262bfafc363d5b2a1f9c2ac90"}
	...
	NewStaffScopeDepartmentList []*UpdateHelpdeskNotificationReqNewStaffScopeDepartment `json:"new_staff_scope_department_list,omitempty"` // 非必填, 新人入职生效部门列表, 示例值: [{"department_id":"od_7c1a2815c9846b5e518b950de0e62de8"}]
	UserList                    []*UpdateHelpdeskNotificationReqUser                    `json:"user_list,omitempty"`                       // 非必填, push推送到成员列表, 示例值: [{"user_id":"ou_7277fd1262bfafc363d5b2a1f9c2ac90"}]
	DepartmentList              []*UpdateHelpdeskNotificationReqDepartment              `json:"department_list,omitempty"`                 // 非必填, push推送到的部门信息列表, 示例值: [{"department_id":"od_7c1a2815c9846b5e518b950de0e62de8"}]
