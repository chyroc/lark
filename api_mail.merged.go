...
func (r *MailService) CreateMailUserAlias(ctx context.Context, request *CreateMailUserAliasReq, options ...MethodOptionFunc) (*CreateMailUserAliasResp, *Response, error) {
	if r.cli.mock.mockMailCreateMailUserAlias != nil {
		r.cli.log(ctx, LogLevelDebug, "[lark] Mail#CreateMailUserAlias mock enable")
		return r.cli.mock.mockMailCreateMailUserAlias(ctx, request, options...)
	}

	req := &RawRequestReq{
		Scope:                 "Mail",
		API:                   "CreateMailUserAlias",
		Method:                "POST",
		URL:                   r.cli.openBaseURL + "/open-apis/mail/v1/users/:user_id/aliases",
		Body:                  request,
		MethodOption:          newMethodOption(options),
		NeedTenantAccessToken: true,
	}
	resp := new(createMailUserAliasResp)
...
func (r *Mock) MockMailCreateMailUserAlias(f func(ctx context.Context, request *CreateMailUserAliasReq, options ...MethodOptionFunc) (*CreateMailUserAliasResp, *Response, error)) {
	r.mockMailCreateMailUserAlias = f
}

func (r *Mock) UnMockMailCreateMailUserAlias() {
	r.mockMailCreateMailUserAlias = nil
}
...
type createMailUserAliasResp struct {
	Code int64                    `json:"code,omitempty"` // 错误码，非 0 表示失败
	Msg  string                   `json:"msg,omitempty"`  // 错误描述
	Data *CreateMailUserAliasResp `json:"data,omitempty"`
}
...
func (r *MailService) DeleteMailUserAlias(ctx context.Context, request *DeleteMailUserAliasReq, options ...MethodOptionFunc) (*DeleteMailUserAliasResp, *Response, error) {
	if r.cli.mock.mockMailDeleteMailUserAlias != nil {
		r.cli.log(ctx, LogLevelDebug, "[lark] Mail#DeleteMailUserAlias mock enable")
		return r.cli.mock.mockMailDeleteMailUserAlias(ctx, request, options...)
	}

	req := &RawRequestReq{
		Scope:                 "Mail",
		API:                   "DeleteMailUserAlias",
		Method:                "DELETE",
		URL:                   r.cli.openBaseURL + "/open-apis/mail/v1/users/:user_id/aliases/:alias_id",
		Body:                  request,
		MethodOption:          newMethodOption(options),
		NeedTenantAccessToken: true,
	}
	resp := new(deleteMailUserAliasResp)
...
func (r *Mock) MockMailDeleteMailUserAlias(f func(ctx context.Context, request *DeleteMailUserAliasReq, options ...MethodOptionFunc) (*DeleteMailUserAliasResp, *Response, error)) {
	r.mockMailDeleteMailUserAlias = f
}

func (r *Mock) UnMockMailDeleteMailUserAlias() {
	r.mockMailDeleteMailUserAlias = nil
}
...
type deleteMailUserAliasResp struct {
	Code int64                    `json:"code,omitempty"` // 错误码，非 0 表示失败
	Msg  string                   `json:"msg,omitempty"`  // 错误描述
	Data *DeleteMailUserAliasResp `json:"data,omitempty"`
}
...
func (r *MailService) GetMailUserAliasList(ctx context.Context, request *GetMailUserAliasListReq, options ...MethodOptionFunc) (*GetMailUserAliasListResp, *Response, error) {
	if r.cli.mock.mockMailGetMailUserAliasList != nil {
		r.cli.log(ctx, LogLevelDebug, "[lark] Mail#GetMailUserAliasList mock enable")
		return r.cli.mock.mockMailGetMailUserAliasList(ctx, request, options...)
	}

	req := &RawRequestReq{
		Scope:                 "Mail",
		API:                   "GetMailUserAliasList",
		Method:                "GET",
		URL:                   r.cli.openBaseURL + "/open-apis/mail/v1/users/:user_id/aliases",
		Body:                  request,
		MethodOption:          newMethodOption(options),
	...
	resp := new(getMailUserAliasListResp)
...
func (r *Mock) MockMailGetMailUserAliasList(f func(ctx context.Context, request *GetMailUserAliasListReq, options ...MethodOptionFunc) (*GetMailUserAliasListResp, *Response, error)) {
	r.mockMailGetMailUserAliasList = f
}

func (r *Mock) UnMockMailGetMailUserAliasList() {
	r.mockMailGetMailUserAliasList = nil
}
...
type getMailUserAliasListResp struct {
	Code int64                     `json:"code,omitempty"` // 错误码，非 0 表示失败
	Msg  string                    `json:"msg,omitempty"`  // 错误描述
	Data *GetMailUserAliasListResp `json:"data,omitempty"`
}
