...
// BatchGetCoreHRByEmployee 查询员工的 HRBP 和属地 BP, 包括来自上级部门的 HRBP 和属地 BP。
//
...
func (r *CoreHRService) BatchGetCoreHRByEmployee(ctx context.Context, request *BatchGetCoreHRByEmployeeReq, options ...MethodOptionFunc) (*BatchGetCoreHRByEmployeeResp, *Response, error) {
	if r.cli.mock.mockCoreHRBatchGetCoreHRByEmployee != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] CoreHR#BatchGetCoreHRByEmployee mock enable")
		return r.cli.mock.mockCoreHRBatchGetCoreHRByEmployee(ctx, request, options...)
	}

	req := &RawRequestReq{
		Scope:                 "CoreHR",
		API:                   "BatchGetCoreHRByEmployee",
		Method:                "POST",
	...
	resp := new(batchGetCoreHRByEmployeeResp)

	response, err := r.cli.RawRequest(ctx, req, resp)
	return resp.Data, response, err
}

// MockCoreHRBatchGetCoreHRByEmployee mock CoreHRBatchGetCoreHRByEmployee method
func (r *Mock) MockCoreHRBatchGetCoreHRByEmployee(f func(ctx context.Context, request *BatchGetCoreHRByEmployeeReq, options ...MethodOptionFunc) (*BatchGetCoreHRByEmployeeResp, *Response, error)) {
	r.mockCoreHRBatchGetCoreHRByEmployee = f
}

// UnMockCoreHRBatchGetCoreHRByEmployee un-mock CoreHRBatchGetCoreHRByEmployee method
func (r *Mock) UnMockCoreHRBatchGetCoreHRByEmployee() {
	r.mockCoreHRBatchGetCoreHRByEmployee = nil
}

// BatchGetCoreHRByEmployeeReq ...
type BatchGetCoreHRByEmployeeReq struct {
...
// BatchGetCoreHRByEmployeeResp ...
type BatchGetCoreHRByEmployeeResp struct {
	EmploymentDirectBps []*BatchGetCoreHRByEmployeeRespEmploymentDirectBp `json:"employment_direct_bps,omitempty"` // 员工直属 BP 信息, 当员工所在部门、属地无 BP 时, 会上钻找到最近的 BP
	EmploymentAllBps    []*BatchGetCoreHRByEmployeeRespEmploymentAllBp    `json:"employment_all_bps,omitempty"`    // 员工全部 BP 信息字段权限要求: 查看员工的全部 BP 信息
}

// BatchGetCoreHRByEmployeeRespEmploymentAllBp ...
type BatchGetCoreHRByEmployeeRespEmploymentAllBp struct {
...
// BatchGetCoreHRByEmployeeRespEmploymentDirectBp ...
type BatchGetCoreHRByEmployeeRespEmploymentDirectBp struct {
...
type batchGetCoreHRByEmployeeResp struct {
	...
	Data  *BatchGetCoreHRByEmployeeResp `json:"data,omitempty"`
