...
type GetDepartmentListReq struct {
	DepartmentID     string            `path:"department_id" json:"-"`       // 部门ID, 根部门的部门ID 为0, department_id的获取方式参见 [部门ID说明](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/field-overview#23857fe0), 示例值: "od-4e6ac4d14bcd5071a37a39de902c7141", 最大长度: `64` 字符, 正则校验: `^0|[^od][A-Za-z0-9]*`
