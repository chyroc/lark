...
func (r *DriveService) CreateDocxDocumentConvert(ctx context.Context, request *CreateDocxDocumentConvertReq, options ...MethodOptionFunc) (*CreateDocxDocumentConvertResp, *Response, error) {
	if r.cli.mock.mockDriveCreateDocxDocumentConvert != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] Drive#CreateDocxDocumentConvert mock enable")
		return r.cli.mock.mockDriveCreateDocxDocumentConvert(ctx, request, options...)
	}
...
// MockDriveCreateDocxDocumentConvert mock DriveCreateDocxDocumentConvert method
func (r *Mock) MockDriveCreateDocxDocumentConvert(f func(ctx context.Context, request *CreateDocxDocumentConvertReq, options ...MethodOptionFunc) (*CreateDocxDocumentConvertResp, *Response, error)) {
	r.mockDriveCreateDocxDocumentConvert = f
}

// UnMockDriveCreateDocxDocumentConvert un-mock DriveCreateDocxDocumentConvert method
func (r *Mock) UnMockDriveCreateDocxDocumentConvert() {
	r.mockDriveCreateDocxDocumentConvert = nil
}
...
type CreateDocxDocumentConvertResp struct {
	...
	Blocks             []*DocxBlock                                      `json:"blocks,omitempty"`                 // 带有父子关系的 Block 列表
...
// CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDoc struct {
	...
	TextElementStyle *CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                              `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDocTextElementStyle struct {
	Bold            bool                                                                                    `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                    `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                    `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                    `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                   `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                   `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUser ...
type CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUser struct {
	UserID           string                                                                               `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUserTextElementStyle struct {
	Bold            bool                                                                                     `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                     `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                     `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                     `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                    `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                    `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                 `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockAgendaItemTitleElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockBulletElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockBulletElementMentionDoc struct {
	Token            string                                                                     `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                      `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                     `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                     `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockBulletElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                     `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockBulletElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockBulletElementMentionDocTextElementStyle struct {
	Bold            bool                                                                           `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                           `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                           `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                           `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                          `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                          `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockBulletElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                       `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockBulletElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockBulletElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockBulletElementMentionUser ...
type CreateDocxDocumentConvertRespBlockBulletElementMentionUser struct {
	UserID           string                                                                      `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockBulletElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockBulletElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockBulletElementMentionUserTextElementStyle struct {
	Bold            bool                                                                            `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                            `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                            `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                            `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                           `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                           `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockBulletElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                        `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockBulletElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockBulletElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockCodeElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockCodeElementMentionDoc struct {
	Token            string                                                                   `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                    `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                   `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                   `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockCodeElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                   `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockCodeElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockCodeElementMentionDocTextElementStyle struct {
	Bold            bool                                                                         `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                         `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                         `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                         `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                        `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                        `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockCodeElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                     `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockCodeElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockCodeElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockCodeElementMentionUser ...
type CreateDocxDocumentConvertRespBlockCodeElementMentionUser struct {
	UserID           string                                                                    `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockCodeElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockCodeElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockCodeElementMentionUserTextElementStyle struct {
	Bold            bool                                                                          `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                          `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                          `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                          `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                         `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                         `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockCodeElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                      `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockCodeElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockCodeElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockEquationElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockEquationElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockEquationElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockEquationElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockEquationElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockEquationElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockEquationElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockEquationElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockEquationElementMentionUser ...
type CreateDocxDocumentConvertRespBlockEquationElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockEquationElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockEquationElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockEquationElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockEquationElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockEquationElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockEquationElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading1ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading1ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading1ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading1ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading1ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading1ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading1ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading1ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading1ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading1ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading1ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading1ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading1ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading1ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading1ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading1ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading2ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading2ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading2ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading2ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading2ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading2ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading2ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading2ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading2ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading2ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading2ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading2ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading2ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading2ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading2ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading2ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading3ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading3ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading3ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading3ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading3ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading3ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading3ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading3ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading3ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading3ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading3ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading3ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading3ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading3ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading3ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading3ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading4ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading4ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading4ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading4ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading4ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading4ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading4ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading4ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading4ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading4ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading4ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading4ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading4ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading4ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading4ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading4ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading5ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading5ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading5ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading5ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading5ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading5ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading5ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading5ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading5ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading5ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading5ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading5ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading5ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading5ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading5ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading5ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading6ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading6ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading6ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading6ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading6ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading6ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading6ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading6ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading6ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading6ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading6ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading6ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading6ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading6ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading6ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading6ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading7ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading7ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading7ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading7ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading7ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading7ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading7ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading7ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading7ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading7ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading7ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading7ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading7ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading7ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading7ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading7ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading8ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading8ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading8ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading8ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading8ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading8ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading8ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading8ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading8ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading8ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading8ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading8ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading8ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading8ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading8ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading8ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockHeading9ElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockHeading9ElementMentionDoc struct {
	Token            string                                                                       `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                        `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                       `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                       `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading9ElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                       `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockHeading9ElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading9ElementMentionDocTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading9ElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading9ElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading9ElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockHeading9ElementMentionUser ...
type CreateDocxDocumentConvertRespBlockHeading9ElementMentionUser struct {
	UserID           string                                                                        `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockHeading9ElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockHeading9ElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockHeading9ElementMentionUserTextElementStyle struct {
	Bold            bool                                                                              `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                              `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                              `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                              `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                             `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                             `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockHeading9ElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                          `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockHeading9ElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockHeading9ElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDoc struct {
	Token            string                                                                                  `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                                   `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                                  `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                                  `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                                  `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDocTextElementStyle struct {
	Bold            bool                                                                                        `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                        `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                        `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                        `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                       `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                       `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                    `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUser ...
type CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUser struct {
	UserID           string                                                                                   `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUserTextElementStyle struct {
	Bold            bool                                                                                         `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                         `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                         `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                         `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                        `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                        `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                     `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRKeyResultContentElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockOKRObjectiveContent ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContent struct {
	Style    *CreateDocxDocumentConvertRespBlockOKRObjectiveContentStyle     `json:"style,omitempty"`    // 文本样式
	Elements []*CreateDocxDocumentConvertRespBlockOKRObjectiveContentElement `json:"elements,omitempty"` // 文本元素
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElement ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElement struct {
	TextRun     *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRun     `json:"text_run,omitempty"`     // 文字。支持对 Page、Text、Heading1~9、Bullet、Ordered、Code、Quote、Todo 块进行修改
	MentionUser *Mention                                                                 `json:"mention_user,omitempty"` // @用户。支持对 Text、Heading1~9、Bullet、Ordered、Quote、Todo 块进行修改。
	MentionDoc  *Mention                                                                 `json:"mention_doc,omitempty"`  // @文档。支持对 Text、Heading1~9、Bullet、Ordered、Quote、Todo 块进行修改
	Reminder    *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminder    `json:"reminder,omitempty"`     // 日期提醒。支持对 Text、Heading1~9、Bullet、Ordered、Quote、Todo 块进行修改
	File        *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFile        `json:"file,omitempty"`         // 内联文件。仅支持删除或移动位置, 不支持创建新的内联文件
	Undefined   interface{}                                                              `json:"undefined,omitempty"`    // 未支持的 TextElement
	InlineBlock *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlock `json:"inline_block,omitempty"` // 内联块。仅支持删除或移动位置, 不支持创建新的内联块
	Equation    *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquation    `json:"equation,omitempty"`     // 公式
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquation ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquation struct {
	Content          string                                                                                `json:"content,omitempty"`            // 符合 KaTeX 语法的公式内容, 语法规则请参考: https://katex.org/docs/supported.html
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquationTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquationTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquationTextElementStyle struct {
	Bold            bool                                                                                      `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                      `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                      `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                      `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                     `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                     `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquationTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                  `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquationTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementEquationTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFile ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFile struct {
	FileToken        string                                                                            `json:"file_token,omitempty"`         // 附件 token
	SourceBlockID    string                                                                            `json:"source_block_id,omitempty"`    // 当前文档中该文件所处的 block 的 ID
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFileTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFileTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFileTextElementStyle struct {
	Bold            bool                                                                                  `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                  `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                  `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                  `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                 `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                 `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFileTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                              `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFileTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementFileTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlock ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlock struct {
	BlockID          string                                                                                   `json:"block_id,omitempty"`           // 关联的内联状态的 block 的 block_id
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlockTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlockTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlockTextElementStyle struct {
	Bold            bool                                                                                         `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                         `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                         `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                         `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                        `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                        `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlockTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                     `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlockTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementInlineBlockTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDoc struct {
	Token            string                                                                                  `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                                   `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                                  `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                                  `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                                  `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDocTextElementStyle struct {
	Bold            bool                                                                                        `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                        `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                        `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                        `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                       `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                       `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                    `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUser ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUser struct {
	UserID           string                                                                                   `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUserTextElementStyle struct {
	Bold            bool                                                                                         `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                         `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                         `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                         `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                        `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                        `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                     `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminder ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminder struct {
	CreateUserID     string                                                                                `json:"create_user_id,omitempty"`     // 创建者用户 ID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	IsNotify         bool                                                                                  `json:"is_notify,omitempty"`          // 是否通知
	IsWholeDay       bool                                                                                  `json:"is_whole_day,omitempty"`       // 是日期还是整点小时
	ExpireTime       string                                                                                `json:"expire_time,omitempty"`        // 事件发生的时间（毫秒级时间戳）
	NotifyTime       string                                                                                `json:"notify_time,omitempty"`        // 触发通知的时间（毫秒级时间戳）
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminderTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminderTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminderTextElementStyle struct {
	Bold            bool                                                                                      `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                      `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                      `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                      `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                     `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                     `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminderTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                  `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminderTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementReminderTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRun ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRun struct {
	Content          string                                                                               `json:"content,omitempty"`            // 文本内容。要实现文本内容的换行, 你可以: 在传入的文本内容中添加 `\n` 实现软换行（Soft Break, 与在文档中通过操作 `Shift + Enter` 的效果一致）- 创建一个新的文本 Block, 实现两个文本 Block 之间的硬换行（Hard Break, 与在文档中通过操作 `Enter` 的效果一致）注意: 软换行在渲染时可能会被忽略, 具体取决于渲染器如何处理；硬换行在渲染时始终会显示为一个新行。
	TextElementStyle *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRunTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRunTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRunTextElementStyle struct {
	Bold            bool                                                                                     `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                     `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                     `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                     `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                    `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                    `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRunTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                                 `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRunTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentElementTextRunTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOKRObjectiveContentStyle ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveContentStyle struct {
	Align            int64  `json:"align,omitempty"`             // 对齐方式可选值有: 居左排版居中排版居右排版
	Done             bool   `json:"done,omitempty"`              // todo 的完成状态。支持对 Todo 块进行修改
	Folded           bool   `json:"folded,omitempty"`            // 文本的折叠状态。支持对 Heading1~9、和有子块的 Text、Ordered、Bullet 和 Todo 块进行修改
	Language         int64  `json:"language,omitempty"`          // 代码块的语言类型。仅支持对 Code 块进行修改可选值有: PlainTextABAPAdaApacheApexAssembly LanguageBashCSharpC++CCOBOLCSSCoffeeScriptDDartDelphiDjangoDockerfileErlangFortranFoxProGoGroovyHTMLHTMLBarsHTTPHaskellJSONJavaJavaScriptJuliaKotlinLateXLispLogoLuaMATLABMakefileMarkdownNginxObjective-COpenEdgeABLPHPPerlPostScriptPower ShellPrologProtoBufPythonRRPGRubyRustSASSCSSSQLScalaSchemeScratchShellSwiftThriftTypeScriptVBScriptVisual BasicXMLYAMLCMakeDiffGherkinGraphQLOpenGL Shading LanguagePropertiesSolidityTOML
...
// CreateDocxDocumentConvertRespBlockOKRObjectiveProgressRate ...
type CreateDocxDocumentConvertRespBlockOKRObjectiveProgressRate struct {
	Mode           string  `json:"mode,omitempty"`            // 状态模式可选值有: 简单模式高级模式
	Current        float64 `json:"current,omitempty"`         // 当前进度, 单位 %, advanced 模式使用
	Percent        float64 `json:"percent,omitempty"`         // 当前进度百分比, simple 模式使用
	ProgressStatus string  `json:"progress_status,omitempty"` // 进展状态可选值有: 未设置正常有风险已延期
...
// CreateDocxDocumentConvertRespBlockOrderedElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockOrderedElementMentionDoc struct {
	Token            string                                                                      `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                       `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                      `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                      `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockOrderedElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                      `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockOrderedElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOrderedElementMentionDocTextElementStyle struct {
	Bold            bool                                                                            `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                            `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                            `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                            `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                           `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                           `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOrderedElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                        `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOrderedElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOrderedElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockOrderedElementMentionUser ...
type CreateDocxDocumentConvertRespBlockOrderedElementMentionUser struct {
	UserID           string                                                                       `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockOrderedElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockOrderedElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockOrderedElementMentionUserTextElementStyle struct {
	Bold            bool                                                                             `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                             `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                             `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                             `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                            `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                            `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockOrderedElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                         `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockOrderedElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockOrderedElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockPageElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockPageElementMentionDoc struct {
	Token            string                                                                   `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                    `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                   `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                   `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockPageElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                   `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockPageElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockPageElementMentionDocTextElementStyle struct {
	Bold            bool                                                                         `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                         `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                         `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                         `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                        `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                        `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockPageElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                     `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockPageElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockPageElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockPageElementMentionUser ...
type CreateDocxDocumentConvertRespBlockPageElementMentionUser struct {
	UserID           string                                                                    `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockPageElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockPageElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockPageElementMentionUserTextElementStyle struct {
	Bold            bool                                                                          `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                          `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                          `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                          `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                         `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                         `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockPageElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                      `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockPageElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockPageElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockQuoteElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockQuoteElementMentionDoc struct {
	Token            string                                                                    `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                     `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                    `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                    `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockQuoteElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                    `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockQuoteElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockQuoteElementMentionDocTextElementStyle struct {
	Bold            bool                                                                          `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                          `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                          `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                          `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                         `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                         `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockQuoteElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                      `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockQuoteElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockQuoteElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockQuoteElementMentionUser ...
type CreateDocxDocumentConvertRespBlockQuoteElementMentionUser struct {
	UserID           string                                                                     `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockQuoteElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockQuoteElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockQuoteElementMentionUserTextElementStyle struct {
	Bold            bool                                                                           `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                           `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                           `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                           `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                          `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                          `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockQuoteElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                       `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockQuoteElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockQuoteElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDoc struct {
	Token            string                                                                           `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                            `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                           `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                           `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                           `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDocTextElementStyle struct {
	Bold            bool                                                                                 `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                 `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                 `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                 `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                             `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUser ...
type CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUser struct {
	UserID           string                                                                            `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUserTextElementStyle struct {
	Bold            bool                                                                                  `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                                  `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                                  `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                                  `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                                 `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                                 `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                              `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockSourceSyncedElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockTextElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockTextElementMentionDoc struct {
	Token            string                                                                   `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                    `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                   `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                   `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockTextElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                   `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockTextElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockTextElementMentionDocTextElementStyle struct {
	Bold            bool                                                                         `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                         `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                         `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                         `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                        `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                        `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockTextElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                     `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockTextElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockTextElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockTextElementMentionUser ...
type CreateDocxDocumentConvertRespBlockTextElementMentionUser struct {
	UserID           string                                                                    `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockTextElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockTextElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockTextElementMentionUserTextElementStyle struct {
	Bold            bool                                                                          `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                          `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                          `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                          `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                         `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                         `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockTextElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                      `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockTextElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockTextElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
...
// CreateDocxDocumentConvertRespBlockTodoElementMentionDoc ...
type CreateDocxDocumentConvertRespBlockTodoElementMentionDoc struct {
	Token            string                                                                   `json:"token,omitempty"`              // 云文档 token。获取方式参考[如何获取云文档资源相关 token（id）](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)
	ObjType          int64                                                                    `json:"obj_type,omitempty"`           // 云文档类型可选值有: DocSheetBitableMindNoteFileSlideWikiDocx
	URL              string                                                                   `json:"url,omitempty"`                // 云文档链接（需要 url_encode)
	Title            string                                                                   `json:"title,omitempty"`              // 文档标题, 只读属性
	TextElementStyle *CreateDocxDocumentConvertRespBlockTodoElementMentionDocTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
	FallbackType     string                                                                   `json:"fallback_type,omitempty"`      // 无云文档阅读权限或云文档已删除时的降级方式可选值有: 降级为超链接形式写入, 超链接的文本内容为当前传入的文档标题, 链接为当前传入的云文档链接（需要 url_encode）降级为文本形式写入, 文本内容为当前传入的云文档链接进行 URL 解码后的结果
}

// CreateDocxDocumentConvertRespBlockTodoElementMentionDocTextElementStyle ...
type CreateDocxDocumentConvertRespBlockTodoElementMentionDocTextElementStyle struct {
	Bold            bool                                                                         `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                         `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                         `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                         `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                        `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                        `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockTodoElementMentionDocTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                     `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockTodoElementMentionDocTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockTodoElementMentionDocTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}

// CreateDocxDocumentConvertRespBlockTodoElementMentionUser ...
type CreateDocxDocumentConvertRespBlockTodoElementMentionUser struct {
	UserID           string                                                                    `json:"user_id,omitempty"`            // 用户 OpenID, ID 类型与查询参数 `user_id_type` 的取值一致。获取方式参考 `user_id_type` 参数说明。
	TextElementStyle *CreateDocxDocumentConvertRespBlockTodoElementMentionUserTextElementStyle `json:"text_element_style,omitempty"` // 文本局部样式
}

// CreateDocxDocumentConvertRespBlockTodoElementMentionUserTextElementStyle ...
type CreateDocxDocumentConvertRespBlockTodoElementMentionUserTextElementStyle struct {
	Bold            bool                                                                          `json:"bold,omitempty"`             // 加粗
	Italic          bool                                                                          `json:"italic,omitempty"`           // 斜体
	Strikethrough   bool                                                                          `json:"strikethrough,omitempty"`    // 删除线
	Underline       bool                                                                          `json:"underline,omitempty"`        // 下划线
	...
	BackgroundColor int64                                                                         `json:"background_color,omitempty"` // 背景色可选值有: 浅红色浅橙色浅黄色浅绿色浅蓝色浅紫色中灰色红色橙色黄色绿色蓝色紫色灰色浅灰色
	TextColor       int64                                                                         `json:"text_color,omitempty"`       // 字体颜色可选值有: 红色橙色黄色绿色蓝色紫色灰色
	Link            *CreateDocxDocumentConvertRespBlockTodoElementMentionUserTextElementStyleLink `json:"link,omitempty"`             // 链接
	CommentIDs      []string                                                                      `json:"comment_ids,omitempty"`      // 评论 ID 列表。在创建 Block 时, 不支持传入评论 ID；在更新文本 Block 的 Element 时, 允许将对应版本已存在的评论 ID 移动到同一个 Block 内的任意 Element 中, 但不支持传入新的评论 ID。如需查询评论内容请阅览「[获取回复](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment-reply/list)」 API。
}

// CreateDocxDocumentConvertRespBlockTodoElementMentionUserTextElementStyleLink ...
type CreateDocxDocumentConvertRespBlockTodoElementMentionUserTextElementStyleLink struct {
	URL string `json:"url,omitempty"` // 超链接指向的 url (需要 url_encode)
}
