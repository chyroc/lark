...
// UpdateTaskV1 该接口用于修改任务的标题、描述、时间、来源等相关信息。
//
...
func (r *TaskV1Service) UpdateTaskV1(ctx context.Context, request *UpdateTaskV1Req, options ...MethodOptionFunc) (*UpdateTaskV1Resp, *Response, error) {
	if r.cli.mock.mockTaskV1UpdateTaskV1 != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] TaskV1#UpdateTaskV1 mock enable")
		return r.cli.mock.mockTaskV1UpdateTaskV1(ctx, request, options...)
	}
	...
	resp := new(updateTaskV1Resp)

	response, err := r.cli.RawRequest(ctx, req, resp)
	return resp.Data, response, err
}

// MockTaskV1UpdateTaskV1 mock TaskV1UpdateTaskV1 method
func (r *Mock) MockTaskV1UpdateTaskV1(f func(ctx context.Context, request *UpdateTaskV1Req, options ...MethodOptionFunc) (*UpdateTaskV1Resp, *Response, error)) {
	r.mockTaskV1UpdateTaskV1 = f
}

// UnMockTaskV1UpdateTaskV1 un-mock TaskV1UpdateTaskV1 method
func (r *Mock) UnMockTaskV1UpdateTaskV1() {
	r.mockTaskV1UpdateTaskV1 = nil
}

// UpdateTaskV1Req ...
type UpdateTaskV1Req struct {
	...
	Task         *UpdateTaskV1ReqTask `json:"task,omitempty"`          // 被更新的任务实体基础信息
...
// UpdateTaskV1ReqTask ...
type UpdateTaskV1ReqTask struct {
	...
	Due             *UpdateTaskV1ReqTaskDue            `json:"due,omitempty"`              // 任务的截止时间设置
	Origin          *UpdateTaskV1ReqTaskOrigin         `json:"origin,omitempty"`           // 任务关联的第三方平台来源信息
	...
	Followers       []*UpdateTaskV1ReqTaskFollower     `json:"followers,omitempty"`        // 任务的关注者示例值: ou_03c21c80caea2c816665f8056dc59027
	Collaborators   []*UpdateTaskV1ReqTaskCollaborator `json:"collaborators,omitempty"`    // 任务的执行者示例值: ou_558d4999baae26e32aa2fd9bb228660b
...
// UpdateTaskV1ReqTaskCollaborator ...
type UpdateTaskV1ReqTaskCollaborator struct {
...
// UpdateTaskV1ReqTaskDue ...
type UpdateTaskV1ReqTaskDue struct {
...
// UpdateTaskV1ReqTaskFollower ...
type UpdateTaskV1ReqTaskFollower struct {
...
// UpdateTaskV1ReqTaskOrigin ...
type UpdateTaskV1ReqTaskOrigin struct {
	...
	Href             *UpdateTaskV1ReqTaskOriginHref `json:"href,omitempty"`               // 任务关联的来源平台详情页链接
}

// UpdateTaskV1ReqTaskOriginHref ...
type UpdateTaskV1ReqTaskOriginHref struct {
...
// UpdateTaskV1Resp ...
type UpdateTaskV1Resp struct {
	Task *UpdateTaskV1RespTask `json:"task,omitempty"` // 返回修改后的任务详情
}

// UpdateTaskV1RespTask ...
type UpdateTaskV1RespTask struct {
	...
	Due             *UpdateTaskV1RespTaskDue            `json:"due,omitempty"`              // 任务的截止时间设置
	Origin          *UpdateTaskV1RespTaskOrigin         `json:"origin,omitempty"`           // 任务关联的第三方平台来源信息
	...
	Followers       []*UpdateTaskV1RespTaskFollower     `json:"followers,omitempty"`        // 任务的关注者
	Collaborators   []*UpdateTaskV1RespTaskCollaborator `json:"collaborators,omitempty"`    // 任务的执行者
...
// UpdateTaskV1RespTaskCollaborator ...
type UpdateTaskV1RespTaskCollaborator struct {
...
// UpdateTaskV1RespTaskDue ...
type UpdateTaskV1RespTaskDue struct {
...
// UpdateTaskV1RespTaskFollower ...
type UpdateTaskV1RespTaskFollower struct {
	ID     string   `json:"id,omitempty"`      // 任务关注人 ID
	IDList []string `json:"id_list,omitempty"` // 要删除的关注人ID列表
}

// UpdateTaskV1RespTaskOrigin ...
type UpdateTaskV1RespTaskOrigin struct {
	...
	Href             *UpdateTaskV1RespTaskOriginHref `json:"href,omitempty"`               // 任务关联的来源平台详情页链接
}

// UpdateTaskV1RespTaskOriginHref ...
type UpdateTaskV1RespTaskOriginHref struct {
...
type updateTaskV1Resp struct {
	...
	Data  *UpdateTaskV1Resp `json:"data,omitempty"`
