...
type UpdateTaskV1ReqTask struct {
	...
	Followers       []*UpdateTaskV1ReqTaskFollower     `json:"followers,omitempty"`        // 任务的关注者, 示例值: ou_03c21c80caea2c816665f8056dc59027
	Collaborators   []*UpdateTaskV1ReqTaskCollaborator `json:"collaborators,omitempty"`    // 任务的执行者, 示例值: ou_558d4999baae26e32aa2fd9bb228660b
...
type UpdateTaskV1ReqTaskCollaborator struct {
	ID     *string  `json:"id,omitempty"`      // 任务执行者的 ID, 传入的值为 user_id 或 open_id, 由user_id_type 决定。user_id和open_id的获取可见文档[如何获取不同的用户 ID](https://open.feishu.cn/document/home/user-identity-introduction/open-id), 已经废弃, 为了向前兼容早期只支持单次添加一个人的情况而保留, 但不再推荐使用, 建议使用id_list字段, 示例值: "ou_99e1a581b36ecc4862cbfbce473f1234"
