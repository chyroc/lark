...
type GetOKRReviewReq struct {
	...
	UserIDs    []string `query:"user_ids" json:"-"`     // 目标用户id列表, 最多5个, 示例值: ou_e6139117c300506837def50545420c6a, 最大长度: `5`
	PeriodIDs  []string `query:"period_ids" json:"-"`   // period_id列表, 最多5个, 示例值: 7067724095781142548, 最大长度: `5`
}
