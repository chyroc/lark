...
type UpdateApplicationFeedbackReq struct {
	...
	FeedbackID string  `path:"feedback_id" json:"-"`   // 应用反馈记录id示例值: "7057888018203574291"
	...
	Status     int64   `query:"status" json:"-"`       // 反馈处理状态示例值: 1可选值有: 反馈未处理反馈已处理反馈处理中反馈已关闭
	OperatorID string  `query:"operator_id" json:"-"`  // 反馈处理人员id, 租户内用户的唯一标识, ID值与查询参数中的user_id_type 对应示例值: ou_9565b69967831233761cc2f11b4c089f
}
