...
func (r *VCMeetingService) ListVCMeetingDefaultRoom(ctx context.Context, request *ListVCMeetingDefaultRoomReq, options ...MethodOptionFunc) (*ListVCMeetingDefaultRoomResp, *Response, error) {
	...
	resp := new(listVCMeetingDefaultRoomResp)
...
type ListVCMeetingDefaultRoomReq struct {
...
type ListVCMeetingDefaultRoomResp struct {
	...
	Rooms     []*ListVCMeetingDefaultRoomRespRoom `json:"rooms,omitempty"`      // 会议室列表
}

// ListVCMeetingDefaultRoomRespRoom ...
type ListVCMeetingDefaultRoomRespRoom struct {
