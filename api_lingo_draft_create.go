...
type CreateLingoDraftReq struct {
	...
	RichText    *string                         `json:"rich_text,omitempty"`    // 富文本格式（当填写富文本内容时, description字段将会失效可不填写）, 支持的格式参考[企业百科指南](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/baike-v1/overview)中的释义部分示例值: "<b>加粗</b><i>斜体</i>l链接企业百科是飞书提供的一款知识管理工具, 通过企业百科可以帮助企业将分散的知识信息进行聚合, 并通过UGC的方式, 促进企业知识的保鲜和流通" 最大长度: `5000` 字符
...
type CreateLingoDraftReqI18nDesc struct {
	...
	RichText    *string `json:"rich_text,omitempty"`   // 富文本描述示例值: "<b>加粗</b><i>斜体</i>l链接企业百科是飞书提供的一款知识管理工具, 通过企业百科可以帮助企业将分散的知识信息进行聚合, 并通过UGC的方式, 促进企业知识的保鲜和流通" 长度范围: `1` ～ `5000` 字符
}
