...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDsReq ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsReq struct {
...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDsResp ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsResp struct {
	JobChanges []*OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChange `json:"job_changes,omitempty"` // 人员异动记录信息列表
}

// OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChange ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChange struct {
	...
	TransferInfo *OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfo `json:"transfer_info,omitempty"` // 异动详细信息
}

// OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfo ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfo struct {
	...
	OriginalDepartmentIDPath             []*OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoOriginalDepartmentIDPath `json:"original_department_id_path,omitempty"`               // 原部门全路径, 从根部门开始自上而下返回部门 ID 列表, 主要用于 API 场景, 没有审批完成前获取部门路径用于计算。
	TargetDepartmentIDPath               []*OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoTargetDepartmentIDPath   `json:"target_department_id_path,omitempty"`                 // 新部门全路径, 从根部门开始自上而下返回部门 ID 列表
	...
	OriginalCostCenterRate               []*OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoOriginalCostCenterRate   `json:"original_cost_center_rate,omitempty"`                 // 原成本中心分摊方式
	TargetCostCenterRate                 []*OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoTargetCostCenterRate     `json:"target_cost_center_rate,omitempty"`                   // 新成本中心分摊方式
...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoOriginalCostCenterRate ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoOriginalCostCenterRate struct {
...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoOriginalDepartmentIDPath ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoOriginalDepartmentIDPath struct {
...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoTargetCostCenterRate struct {
	CostCenterID string  `json:"cost_center_id,omitempty"` // 成本中心 ID, 可以通过[【搜索成本中心信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口获取对应的成本中心信息
	Rate         int64   `json:"rate,omitempty"`           // 分摊比例(整数) 成本分摊百分比的整数部分, 实际值为小数时向下取整（比如: 12.99→ 12）, 如需小数请使用分摊比例字段。
	NewRate      float64 `json:"new_rate,omitempty"`       // 分摊比例 成本分摊百分比, 可能包含小数位。- 功能灰度中, 成本分摊功能灰度开放前无值。
}

// OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoTargetDepartmentIDPath ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDsRespJobChangeTransferInfoTargetDepartmentIDPath struct {
	DepartmentID      string `json:"department_id,omitempty"`       // 部门 ID, 对于在本次调整中新建的部门, 在调整未生效时将返回为空。支持根据部门 ID 类型转换
...
type openCorehrApprovalGroupsQueryJobChangeListByIDsResp struct {
	...
	Data  *OpenCorehrApprovalGroupsQueryJobChangeListByIDsResp `json:"data,omitempty"`
