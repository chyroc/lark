...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDs 根据人员异动记录 ID 批量查询人员调整内容
//
...
func (r *CorehrService) OpenCorehrApprovalGroupsQueryJobChangeListByIDs(ctx context.Context, request *OpenCorehrApprovalGroupsQueryJobChangeListByIDsReq, options ...MethodOptionFunc) (*OpenCorehrApprovalGroupsQueryJobChangeListByIDsResp, *Response, error) {
	if r.cli.mock.mockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] Corehr#OpenCorehrApprovalGroupsQueryJobChangeListByIDs mock enable")
		return r.cli.mock.mockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs(ctx, request, options...)
	}

	req := &RawRequestReq{
		Scope:                 "Corehr",
		API:                   "OpenCorehrApprovalGroupsQueryJobChangeListByIDs",
		Method:                "POST",
	...
	resp := new(openCorehrApprovalGroupsQueryJobChangeListByIDsResp)

	response, err := r.cli.RawRequest(ctx, req, resp)
	return resp.Data, response, err
}

// MockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs mock CorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs method
func (r *Mock) MockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs(f func(ctx context.Context, request *OpenCorehrApprovalGroupsQueryJobChangeListByIDsReq, options ...MethodOptionFunc) (*OpenCorehrApprovalGroupsQueryJobChangeListByIDsResp, *Response, error)) {
	r.mockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs = f
}

// UnMockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs un-mock CorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs method
func (r *Mock) UnMockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs() {
	r.mockCorehrOpenCorehrApprovalGroupsQueryJobChangeListByIDs = nil
}

// OpenCorehrApprovalGroupsQueryJobChangeListByIDReq ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDReq struct {
...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDResp ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDResp struct {
	JobChanges []*OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChange `json:"job_changes,omitempty"` // 人员异动记录信息列表
}

// OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChange ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChange struct {
	...
	TransferInfo *OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfo `json:"transfer_info,omitempty"` // 异动详细信息
}

// OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfo ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfo struct {
	...
	OriginalDepartmentIDPath             []*OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoOriginalDepartmentIDPath `json:"original_department_id_path,omitempty"`               // 原部门全路径, 从根部门开始自上而下返回部门 ID 列表, 主要用于 API 场景, 没有审批完成前获取部门路径用于计算。
	TargetDepartmentIDPath               []*OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoTargetDepartmentIDPath   `json:"target_department_id_path,omitempty"`                 // 新部门全路径, 从根部门开始自上而下返回部门 ID 列表
	...
	OriginalCostCenterRate               []*OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoOriginalCostCenterRate   `json:"original_cost_center_rate,omitempty"`                 // 原成本中心分摊方式
	TargetCostCenterRate                 []*OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoTargetCostCenterRate     `json:"target_cost_center_rate,omitempty"`                   // 新成本中心分摊方式
...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoOriginalCostCenterRate ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoOriginalCostCenterRate struct {
...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoOriginalDepartmentIDPath ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoOriginalDepartmentIDPath struct {
...
// OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoTargetCostCenterRate ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoTargetCostCenterRate struct {
	CostCenterID string  `json:"cost_center_id,omitempty"` // 成本中心 ID, 可以通过[【搜索成本中心信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口获取对应的成本中心信息
	Rate         int64   `json:"rate,omitempty"`           // 分摊比例(整数) 成本分摊百分比的整数部分, 实际值为小数时向下取整（比如: 12.99→ 12）, 如需小数请使用分摊比例字段。
	NewRate      float64 `json:"new_rate,omitempty"`       // 分摊比例 成本分摊百分比, 可能包含小数位。- 功能灰度中, 成本分摊功能灰度开放前无值。
}

// OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoTargetDepartmentIDPath ...
type OpenCorehrApprovalGroupsQueryJobChangeListByIDRespJobChangeTransferInfoTargetDepartmentIDPath struct {
	DepartmentID      string `json:"department_id,omitempty"`       // 部门 ID, 对于在本次调整中新建的部门, 在调整未生效时将返回为空。支持根据部门 ID 类型转换
...
type openCorehrApprovalGroupsQueryJobChangeListByIDResp struct {
	...
	Data  *OpenCorehrApprovalGroupsQueryJobChangeListByIDResp `json:"data,omitempty"`
