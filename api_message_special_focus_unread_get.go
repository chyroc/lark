...
type GetMessageSpecialFocusUnreadReq struct {
	...
	IDList       []string  `json:"id_list,omitempty"`        // 特别关注ID列表。请根据 [member_id_type] 参数填入`open_id`、`user_id`、`union_id`或`app_id`类型的ID, 示例值: ["ou_e167f0c694cb1c77bb040857dd963024", "ou_a18fe85d22e7633852d8104226e99eac"]
