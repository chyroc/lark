...
type UpdateCoreHREmployeeTypeReq struct {
	EmployeeTypeID      string                                    `path:"employee_type_id" json:"-"`       // 雇员类型 ID- 可通过[批量查询人员类型](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employee_type/list)获取示例值: "6969828847931885087"
	...
	CustomFields        []*UpdateCoreHREmployeeTypeReqCustomField `json:"custom_fields,omitempty"`         // 自定义字段- 具体支持的对象请参考[自定义字段说明](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom-fields-guide)
}
...
type UpdateCoreHREmployeeTypeRespEmployeeType struct {
	...
	CustomFields        []*UpdateCoreHREmployeeTypeRespEmployeeTypeCustomField `json:"custom_fields,omitempty"`         // 自定义字段- 具体支持的对象请参考[自定义字段说明](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom-fields-guide)
}
