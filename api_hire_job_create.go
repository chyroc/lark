...
type CreateHireJobReq struct {
	...
	ExpiryTime         int64                             `json:"expiry_time,omitempty"`          // 到期日期, 示例值: 1622484739955
	...
	RecruitmentTypeID  string                            `json:"recruitment_type_id,omitempty"`  // 雇佣类型, 示例值: "102"
	RequiredDegree     *int64                            `json:"required_degree,omitempty"`      // 学历要求, 示例值: 1, 可选值有: 1: 小学及以上, 2: 初中及以上, 3: 专职及以上, 4: 高中及以上, 5: 大专及以上, 6: 本科及以上, 7: 硕士及以上, 8: 博士及以上, 20: 不限
	JobCategoryID      *string                           `json:"job_category_id,omitempty"`      // 序列, 示例值: "6960663240925956550"
	AddressIDList      []string                          `json:"address_id_list,omitempty"`      // 工作地点, 枚举通过接口「获取地址列表」获取, 选择地点用途为「职位地址」, 示例值: 7035374761602959660
	JobAttribute       *int64                            `json:"job_attribute,omitempty"`        // 职位属性, 1是实体职位, 2是虚拟职位, 示例值: 职位类别
}
