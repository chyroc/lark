...
// GetBitableViewList 获取多维表格数据表中的所有视图。
//
...
type GetBitableViewListRespItem struct {
	...
	ViewPublicLevel    string `json:"view_public_level,omitempty"`     // 视图公共等级可选值有: 公共视图锁定视图个人视图
	ViewPrivateOwnerID string `json:"view_private_owner_id,omitempty"` // 个人视图的所有者的 ID, ID 类型和查询参数 user_id_type 保持一致
}
