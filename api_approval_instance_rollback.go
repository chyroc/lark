...
// new doc: https://open.feishu.cn/document/server-docs/approval-v4/task/specified_rollback
...
type RollbackApprovalInstanceReq struct {
	...
	UserID         string   `json:"user_id,omitempty"`           // 当前审批任务的审批人的用户 ID, ID 类型与查询参数 user_id_type 取值一致。可调用[获取单个审批实例详情](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/get), 从返回结果的 task_list 参数中获取用户 ID 以及任务状态必须为 PENDING。示例值: "893g4c45"
