...
// EventV2ContactEmployeeTypeEnumDeactivatedV3 当应用订阅该事件后, 如果将激活的人员类型更新为未激活状态, 则会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=employee_type_enum&event=deactivated)
//
// ## 前提条件
...
// new doc: https://open.feishu.cn/document/server-docs/contact-v3/employee_type_enum/events/deactivated
...
type EventV2ContactEmployeeTypeEnumDeactivatedV3 struct {
	OldEnum *EventV2ContactEmployeeTypeEnumDeactivatedV3OldEnum `json:"old_enum,omitempty"` // 更新前的人员类型信息。
	NewEnum *EventV2ContactEmployeeTypeEnumDeactivatedV3NewEnum `json:"new_enum,omitempty"` // 更新后的人员类型信息。
}
...
type EventV2ContactEmployeeTypeEnumDeactivatedV3NewEnum struct {
	...
	I18nContent []*EventV2ContactEmployeeTypeEnumDeactivatedV3NewEnumI18nContent `json:"i18n_content,omitempty"` // 选项内容的国际化配置。
}
...
type EventV2ContactEmployeeTypeEnumDeactivatedV3OldEnum struct {
	...
	EnumType    int64                                                            `json:"enum_type,omitempty"`    // 人员类型的选项类型。可选值有: 内置类型自定义
	EnumStatus  int64                                                            `json:"enum_status,omitempty"`  // 人员类型的选项激活状态。可选值有: 激活未激活
	I18nContent []*EventV2ContactEmployeeTypeEnumDeactivatedV3OldEnumI18nContent `json:"i18n_content,omitempty"` // 选项内容的国际化配置。
}
