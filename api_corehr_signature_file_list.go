...
type ListCorehrSignatureFileReq struct {
	...
	States          []string `query:"states" json:"-"`            // 电子签文件状态, 枚举值可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)的signature_file_state枚举定义部分获得注意: 多个状态之间为「或」的关系；示例值: sign_finished 长度范围: `0` ～ `30`
	UpdateTimeStart *string  `query:"update_time_start" json:"-"` // 更新时间早于等于某个时间点, 按照东八区时区示例值: 2022-01-01 00:00:00
	UpdateTimeEnd   *string  `query:"update_time_end" json:"-"`   // 更新时间晚于等于某个时间点, 按照东八区时区示例值: 2022-01-01 00:00:00
