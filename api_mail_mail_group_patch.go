...
type UpdateMailGroupPatchReq struct {
	...
	Email          *string `json:"email,omitempty"`             // 邮件组地址示例值: "test_mail_group@xxx.xx"
	Name           *string `json:"name,omitempty"`              // 邮件组名称示例值: "test mail group"
	Description    *string `json:"description,omitempty"`       // 邮件组描述示例值: "mail group for testing"
	WhoCanSendMail *string `json:"who_can_send_mail,omitempty"` // 谁可发送邮件到此邮件组示例值: "ALL_INTERNAL_USERS"可选值有: 任何人仅组织内部成员仅邮件组成员自定义成员
}
