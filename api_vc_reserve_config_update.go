...
type UpdateVCReserveConfigReqApprovalConfigApprover struct {
	UserID string `json:"user_id,omitempty"` // 审批人/预订人id, 示例值: "ou_a27b07a9071d90577c0177bcec98f856"
}

// UpdateVCReserveConfigReqReserveScopeConfig ...
type UpdateVCReserveConfigReqReserveScopeConfig struct {
	AllowAllUsers *int64                                                 `json:"allow_all_users,omitempty"` // 可预定成员范围: 0 代表部分成员, 1 代表全部成员, <b>说明</b>: 1.  此值必填, 2.  当设置为 0 时, 至少需要 1 个预订部门或预订人, 示例值: 0, 取值范围: `0` ～ `1`
...
type UpdateVCReserveConfigReqTimeConfig struct {
	...
	DaysInAdvance *int64  `json:"days_in_advance,omitempty"` // 最早可提前, days_in_advance 预定会议室（单位: 天, 取值范围[1-99]）, <b>说明</b>: 不填写时, 默认更新为 2, 示例值: 30, 取值范围: `1` ～ `99`
	OpeningHour   *string `json:"opening_hour,omitempty"`    // 开放当天可于, opening_hour 开始预定（单位: 秒, 取值范围[0, 86400]）, <b>说明</b>: 1.  不填写时默认更新为, 0, 2.  如果填写的值不是 60, 的倍数, 则自动会更新为离其最近的 60 整数倍的值, 示例值: "27900"
	...
	MaxDuration   *int64  `json:"max_duration,omitempty"`    // 单次会议室可预定时长上限（单位: 小时, 取值范围[1, 99]）, <b>说明</b>: 不填写时默认更新为 99, 示例值: 24, 取值范围: `1` ～ `99`
}
