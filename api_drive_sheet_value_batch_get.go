...
// BatchGetSheetValue 读取电子表格中多个指定范围的数据。
//
// ## 使用限制
// - 该接口返回数据的最大限制为 10 MB。
...
type BatchGetSheetValueResp struct {
	...
	ValueRanges      []*BatchGetSheetValueRespValueRange `json:"valueRanges,omitempty"`      // 读取的值与范围
}
