...
// new doc: https://open.feishu.cn/document/group/upgraded-group-announcement/chat-announcement-block/batch_delete
func (r *DriveService) BatchDeleteDocxChatAnnouncementBlockChildren(ctx context.Context, request *BatchDeleteDocxChatAnnouncementBlockChildrenReq, options ...MethodOptionFunc) (*BatchDeleteDocxChatAnnouncementBlockChildrenResp, *Response, error) {
	if r.cli.mock.mockDriveBatchDeleteDocxChatAnnouncementBlockChildren != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] Drive#BatchDeleteDocxChatAnnouncementBlockChildren mock enable")
		return r.cli.mock.mockDriveBatchDeleteDocxChatAnnouncementBlockChildren(ctx, request, options...)
	}
...
// MockDriveBatchDeleteDocxChatAnnouncementBlockChildren mock DriveBatchDeleteDocxChatAnnouncementBlockChildren method
func (r *Mock) MockDriveBatchDeleteDocxChatAnnouncementBlockChildren(f func(ctx context.Context, request *BatchDeleteDocxChatAnnouncementBlockChildrenReq, options ...MethodOptionFunc) (*BatchDeleteDocxChatAnnouncementBlockChildrenResp, *Response, error)) {
	r.mockDriveBatchDeleteDocxChatAnnouncementBlockChildren = f
}

// UnMockDriveBatchDeleteDocxChatAnnouncementBlockChildren un-mock DriveBatchDeleteDocxChatAnnouncementBlockChildren method
func (r *Mock) UnMockDriveBatchDeleteDocxChatAnnouncementBlockChildren() {
	r.mockDriveBatchDeleteDocxChatAnnouncementBlockChildren = nil
}
