...
type CreateAdminBadgeReq struct {
	...
	I18nName        *CreateAdminBadgeReqI18nName        `json:"i18n_name,omitempty"`        // 勋章的多语言名称, 同name字段限制, 最多30个字符。
	I18nExplanation *CreateAdminBadgeReqI18nExplanation `json:"i18n_explanation,omitempty"` // 勋章的多语言描述文案, 同explanation字段限制, 最多100个字符。
}
