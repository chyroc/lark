...
type CreateDriveFolderReq struct {
	Name        string `json:"name,omitempty"`         // 文件夹名称长度限制: 1~256 个字节示例值: "产品优化项目"
	FolderToken string `json:"folder_token,omitempty"` // 父文件夹的 token。参数为空字符串时, 表示在根目录下创建文件夹。你可参考[获取文件夹中的文件清单](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file/list)获取某个文件夹的 token。了解更多, 参考[文件夹概述](https://open.feishu.cn/document/ukTMukTMukTM/ugTNzUjL4UzM14CO1MTN/folder-overview)。示例值: "fldbcO1UuPz8VwnpPx5a92abcef"
}
