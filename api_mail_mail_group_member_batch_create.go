...
type BatchCreateMailGroupMemberReqItem struct {
	...
	Type         *MailUserType `json:"type,omitempty"`          // 成员类型, 示例值: "USER", 可选值有: USER: 内部用户, DEPARTMENT: 部门, COMPANY: 全员, EXTERNAL_USER: 外部用户, MAIL_GROUP: 邮件组, PUBLIC_MAILBOX: member is a public mailbox, OTHER_MEMBER: 内部成员
}
