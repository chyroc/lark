...
// new doc: https://open.feishu.cn/document/im-v2/groups-bots/bot_time_sentive
func (r *MessageService) UpdateIMFeedCardBotTimeSentive(ctx context.Context, request *UpdateIMFeedCardBotTimeSentiveReq, options ...MethodOptionFunc) (*UpdateIMFeedCardBotTimeSentiveResp, *Response, error) {
	if r.cli.mock.mockMessageUpdateIMFeedCardBotTimeSentive != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] Message#UpdateIMFeedCardBotTimeSentive mock enable")
		return r.cli.mock.mockMessageUpdateIMFeedCardBotTimeSentive(ctx, request, options...)
	}
...
// MockMessageUpdateIMFeedCardBotTimeSentive mock MessageUpdateIMFeedCardBotTimeSentive method
func (r *Mock) MockMessageUpdateIMFeedCardBotTimeSentive(f func(ctx context.Context, request *UpdateIMFeedCardBotTimeSentiveReq, options ...MethodOptionFunc) (*UpdateIMFeedCardBotTimeSentiveResp, *Response, error)) {
	r.mockMessageUpdateIMFeedCardBotTimeSentive = f
}

// UnMockMessageUpdateIMFeedCardBotTimeSentive un-mock MessageUpdateIMFeedCardBotTimeSentive method
func (r *Mock) UnMockMessageUpdateIMFeedCardBotTimeSentive() {
	r.mockMessageUpdateIMFeedCardBotTimeSentive = nil
}
