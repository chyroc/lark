...
// EventV1ThirdPartyMeetingRoomEventUpdated 当添加了第三方会议室的日程发生变动时（创建/更新/删除）触发此事件, 其中更新日程时, 仅当更新日程时间后触发此事件。
//
...
type EventV1ThirdPartyMeetingRoomEventUpdated struct {
	...
	Start        *EventV1ThirdPartyMeetingRoomEventUpdatedStart     `json:"start,omitempty"`         // 日程开始时间
	End          *EventV1ThirdPartyMeetingRoomEventUpdatedEnd       `json:"end,omitempty"`           // 日程结束时间
	MeetingRooms []string                                           `json:"meeting_rooms,omitempty"` // 日程关联的会议室
	Organizer    *EventV1ThirdPartyMeetingRoomEventUpdatedOrganizer `json:"organizer,omitempty"`     // 日程的组织者
}

// EventV1ThirdPartyMeetingRoomEventUpdatedEnd ...
type EventV1ThirdPartyMeetingRoomEventUpdatedEnd struct {
	TimeStamp string `json:"time_stamp,omitempty"` // 日程结束时间戳
}

// EventV1ThirdPartyMeetingRoomEventUpdatedMeetingRoom ...
type EventV1ThirdPartyMeetingRoomEventUpdatedMeetingRoom struct {
	OpenID string `json:"open_id,omitempty"` // 会议室 ID
}

// EventV1ThirdPartyMeetingRoomEventUpdatedOrganizer ...
type EventV1ThirdPartyMeetingRoomEventUpdatedOrganizer struct {
