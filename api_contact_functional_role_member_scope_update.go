...
type UpdateContactFunctionalRoleMemberScopeReq struct {
	...
	Members          []string          `json:"members,omitempty"`            // 角色修改的角色成员列表（一批用户的UserID列表), 示例值: ["adasd"], 长度范围: `1` ～ `100`
	Departments      []string          `json:"departments,omitempty"`        // 角色内用户的管理范围, 示例值: ["adasd"], 长度范围: `1` ～ `100`
}
