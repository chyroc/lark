...
type GetCoreHRAuthorizationListRespItemPermissionDetail struct {
	...
	GrantorRuleList          []*GetCoreHRAuthorizationListRespItemPermissionDetailGrantorRule `json:"grantor_rule_list,omitempty"`          // 设置数据权限, 如果该值为null, 则使用指定管理对象列表(assigned_organization_list)
