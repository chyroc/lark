...
type SendHelpdeskTicketMessageReq struct {
	TicketID string  `path:"ticket_id" json:"-"` // 工单ID示例值: "6948728206392295444"
	MsgType  MsgType `json:"msg_type,omitempty"` // 消息类型；text: 纯文本；post: 富文本示例值: "post"
	Content  string  `json:"content,omitempty"`  // --纯文本, 参考[发送文本消息](https://open.feishu.cn/document/ukTMukTMukTM/uUjNz4SN2MjL1YzM)中的content；- 富文本, 参考[发送富文本消息](https://open.feishu.cn/document/ukTMukTMukTM/uMDMxEjLzATMx4yMwETM)中的content示例值: "{    "msg_type": "post", "content": {        "post": {            "zh_cn": {                "title": "this is title", "content": [                    [                        {                            "tag": "text", "un_escape": true, "text": "第一行:"                        }, {                            "tag": "a", "text": "超链接", "href": "http://www.feishu.cn"                        }                    ], [                        {                            "tag": "text", "text": "第二行 :"                        }, {                            "tag": "text", "text": "文本测试"                        }                    ]                ]            }        }    }}"
}
