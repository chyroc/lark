...
type CreateBitableRecordReq struct {
	...
	Fields      map[string]interface{} `json:"fields,omitempty"`       // 数据表的字段, 即数据表的列, 当前接口支持的字段类型为: 多行文本、单选、条码、多选、日期、人员、附件、复选框、超链接、数字、单向关联、双向关联、电话号码、地理位置。详情参考[接入指南](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/bitable/notification#31f78a3c), 不同类型字段的数据结构请参考[数据结构概述](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/bitable/development-guide/bitable-structure), 示例值: {, "多行文本":"HelloWorld", }
}
