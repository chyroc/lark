...
func TestHeader(t *testing.T) {
	tests := []struct {
		...
		{"2", card.Header("# header").SetRed(), `{"template":"red","title":{"tag":"plain_text","content":"# header"}}`},
		{"2", card.Header("# header").SetYellow(), `{"template":"yellow","title":{"tag":"plain_text","content":"# header"}}`},
	}
