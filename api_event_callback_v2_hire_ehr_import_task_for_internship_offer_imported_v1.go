...
// EventV2HireEHRImportTaskForInternshipOfferImportedV1 在用户点击「导入 e-HR（实习）」后, 推送候选人信息至订阅系统中{使用示例}(url=/api/tools/api_explore/api_explore_config?project=hire&version=v1&resource=ehr_import_task_for_internship_offer&event=imported)
//
