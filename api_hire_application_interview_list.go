...
type GetHireApplicationInterviewListReq struct {
	ApplicationID string  `path:"application_id" json:"-"` // 投递ID示例值: "6949805467799537964"
	PageSize      int64   `query:"page_size" json:"-"`     // 分页大小, 不能超过 50示例值: 10
	PageToken     *string `query:"page_token" json:"-"`    // 分页标记, 第一次请求不填, 表示从头开始遍历；分页查询结果还有更多项时会同时返回新的 page_token, 下次遍历可采用该 page_token 获取查询结果示例值: "xx"
...
type GetHireApplicationInterviewListRespItemInterviewRecord struct {
	...
	CommitStatus   int64                                                                 `json:"commit_status,omitempty"`    // 提交状态可选值有: `1`: 已提交- `2`: 未提交
	Conclusion     int64                                                                 `json:"conclusion,omitempty"`       // 面试结论可选值有: `1`: 通过- `2`: 未通过- `3`: 未开始- `4`: 未提交- `5`: 未到场
