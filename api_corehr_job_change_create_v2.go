...
// CreateCoreHRJobChangeV2 该接口用于发起员工异动（变更员工雇佣信息）, 若发起成功, 会生成一条员工的异动数据
//
...
func (r *CoreHRService) CreateCoreHRJobChangeV2(ctx context.Context, request *CreateCoreHRJobChangeV2Req, options ...MethodOptionFunc) (*CreateCoreHRJobChangeV2Resp, *Response, error) {
	if r.cli.mock.mockCoreHRCreateCoreHRJobChangeV2 != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] CoreHR#CreateCoreHRJobChangeV2 mock enable")
		return r.cli.mock.mockCoreHRCreateCoreHRJobChangeV2(ctx, request, options...)
	}

	req := &RawRequestReq{
		Scope:                 "CoreHR",
		API:                   "CreateCoreHRJobChangeV2",
		Method:                "POST",
	...
	resp := new(createCoreHRJobChangeV2Resp)

	response, err := r.cli.RawRequest(ctx, req, resp)
	return resp.Data, response, err
}

// MockCoreHRCreateCoreHRJobChangeV2 mock CoreHRCreateCoreHRJobChangeV2 method
func (r *Mock) MockCoreHRCreateCoreHRJobChangeV2(f func(ctx context.Context, request *CreateCoreHRJobChangeV2Req, options ...MethodOptionFunc) (*CreateCoreHRJobChangeV2Resp, *Response, error)) {
	r.mockCoreHRCreateCoreHRJobChangeV2 = f
}

// UnMockCoreHRCreateCoreHRJobChangeV2 un-mock CoreHRCreateCoreHRJobChangeV2 method
func (r *Mock) UnMockCoreHRCreateCoreHRJobChangeV2() {
	r.mockCoreHRCreateCoreHRJobChangeV2 = nil
}

// CreateCoreHRJobChangeV2Req ...
type CreateCoreHRJobChangeV2Req struct {
	...
	TransferInfo                   *CreateCoreHRJobChangeV2ReqTransferInfo `json:"transfer_info,omitempty"`                     // 异动详细信息, 以下参数如不传, 无默认值, 代表对应数据无异动
...
// CreateCoreHRJobChangeV2ReqTransferInfo ...
type CreateCoreHRJobChangeV2ReqTransferInfo struct {
	...
	TargetCostCenterRates    []*CreateCoreHRJobChangeV2ReqTransferInfoTargetCostCenterRate `json:"target_cost_center_rates,omitempty"`    // 新成本中心分摊方式 长度范围: `0` ～ `100`
	TargetEmploymentChange   *CreateCoreHRJobChangeV2ReqTransferInfoTargetEmploymentChange `json:"target_employment_change,omitempty"`    // 新工作信息
...
// CreateCoreHRJobChangeV2ReqTransferInfoTargetCostCenterRate ...
type CreateCoreHRJobChangeV2ReqTransferInfoTargetCostCenterRate struct {
...
type CreateCoreHRJobChangeV2ReqTransferInfoTargetEmploymentChange struct {
	...
	CustomFields             []*CreateCoreHRJobChangeV2ReqTransferInfoTargetEmploymentChangeCustomField `json:"custom_fields,omitempty"`               // 自定义字段
}

// CreateCoreHRJobChangeV2ReqTransferInfoTargetEmploymentChangeCustomField ...
type CreateCoreHRJobChangeV2ReqTransferInfoTargetEmploymentChangeCustomField struct {
...
// CreateCoreHRJobChangeV2Resp ...
type CreateCoreHRJobChangeV2Resp struct {
	...
	TransferInfo                   *CreateCoreHRJobChangeV2RespTransferInfo  `json:"transfer_info,omitempty"`                     // 异动详细信息
	IsAdjustSalary                 bool                                      `json:"is_adjust_salary,omitempty"`                  // 是否调整薪酬字段权限要求: 获取异动单据是否调薪字段
	CustomFields                   []*CreateCoreHRJobChangeV2RespCustomField `json:"custom_fields,omitempty"`                     // 异动自定义字段字段权限要求: 获取员工异动自定义字段信息
}

// CreateCoreHRJobChangeV2RespCustomField ...
type CreateCoreHRJobChangeV2RespCustomField struct {
	CustomApiName string                                      `json:"custom_api_name,omitempty"` // 自定义字段 apiname, 即自定义字段的唯一标识
	Name          *CreateCoreHRJobChangeV2RespCustomFieldName `json:"name,omitempty"`            // 自定义字段名称
...
// CreateCoreHRJobChangeV2RespCustomFieldName ...
type CreateCoreHRJobChangeV2RespCustomFieldName struct {
	ZhCn string `json:"zh_cn,omitempty"` // 中文
	EnUs string `json:"en_us,omitempty"` // 英文
}

// CreateCoreHRJobChangeV2RespTransferInfo ...
type CreateCoreHRJobChangeV2RespTransferInfo struct {
	...
	OriginalCostCenterRate     []*CreateCoreHRJobChangeV2RespTransferInfoOriginalCostCenterRate `json:"original_cost_center_rate,omitempty"`     // 原成本中心分摊方式
	TargetCostCenterRate       []*CreateCoreHRJobChangeV2RespTransferInfoTargetCostCenterRate   `json:"target_cost_center_rate,omitempty"`       // 新成本中心分摊方式
	OriginalEmploymentChange   *CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChange `json:"original_employment_change,omitempty"`    // 原工作信息
	TargetEmploymentChange     *CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChange   `json:"target_employment_change,omitempty"`      // 新工作信息
...
// CreateCoreHRJobChangeV2RespTransferInfoOriginalCostCenterRate ...
type CreateCoreHRJobChangeV2RespTransferInfoOriginalCostCenterRate struct {
...
// CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChange ...
type CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChange struct {
	...
	CustomFields             []*CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChangeCustomField `json:"custom_fields,omitempty"`               // 自定义字段字段权限要求: 获取异动工作信息自定义字段
}

// CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChangeCustomField ...
type CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChangeCustomField struct {
	CustomApiName string                                                                          `json:"custom_api_name,omitempty"` // 自定义字段 apiname, 即自定义字段的唯一标识
	Name          *CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChangeCustomFieldName `json:"name,omitempty"`            // 自定义字段名称
	Type          int64                                                                           `json:"type,omitempty"`            // 自定义字段类型
	Value         string                                                                          `json:"value,omitempty"`           // 字段值, 是 json 转义后的字符串, 根据元数据定义不同, 字段格式不同（如 123, 123.23, "true", ["id1", "id2"], "2006-01-02 15:04:05"）
}

// CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChangeCustomFieldName ...
type CreateCoreHRJobChangeV2RespTransferInfoOriginalEmploymentChangeCustomFieldName struct {
	ZhCn string `json:"zh_cn,omitempty"` // 中文
	EnUs string `json:"en_us,omitempty"` // 英文
}

// CreateCoreHRJobChangeV2RespTransferInfoTargetCostCenterRate ...
type CreateCoreHRJobChangeV2RespTransferInfoTargetCostCenterRate struct {
	CostCenterID string `json:"cost_center_id,omitempty"` // 成本中心 ID, 可以通过【查询单个成本中心信息】接口获取对应的成本中心信息
	Rate         int64  `json:"rate,omitempty"`           // 分摊比例(整数)
}

// CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChange ...
type CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChange struct {
	RegularEmployeeStartDate string                                                                      `json:"regular_employee_start_date,omitempty"` // 转正式员工日期
	SeniorityDate            string                                                                      `json:"seniority_date,omitempty"`              // 司龄起算日期
	EmployeeNumber           string                                                                      `json:"employee_number,omitempty"`             // 员工编号
	CustomFields             []*CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChangeCustomField `json:"custom_fields,omitempty"`               // 自定义字段字段权限要求: 获取异动工作信息自定义字段
}

// CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChangeCustomField ...
type CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChangeCustomField struct {
	CustomApiName string                                                                        `json:"custom_api_name,omitempty"` // 自定义字段 apiname, 即自定义字段的唯一标识
	Name          *CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChangeCustomFieldName `json:"name,omitempty"`            // 自定义字段名称
	Type          int64                                                                         `json:"type,omitempty"`            // 自定义字段类型
	Value         string                                                                        `json:"value,omitempty"`           // 字段值, 是 json 转义后的字符串, 根据元数据定义不同, 字段格式不同（如 123, 123.23, "true", ["id1", "id2"], "2006-01-02 15:04:05"）
}

// CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChangeCustomFieldName ...
type CreateCoreHRJobChangeV2RespTransferInfoTargetEmploymentChangeCustomFieldName struct {
	ZhCn string `json:"zh_cn,omitempty"` // 中文
	EnUs string `json:"en_us,omitempty"` // 英文
}
...
type createCoreHRJobChangeV2Resp struct {
	...
	Data  *CreateCoreHRJobChangeV2Resp `json:"data,omitempty"`
