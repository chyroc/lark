...
type UpdateApplicationVersionReq struct {
	AppID        string  `path:"app_id" json:"-"`         // 应用 id示例值: "cli_9f3ca975326b501b"
	VersionID    string  `path:"version_id" json:"-"`     // 唯一标识应用版本的 ID示例值: "oav_d317f090b7258ad0372aa53963cda70d"
	...
	OperatorID   string  `query:"operator_id" json:"-"`   // 操作者的 open_id示例值: ou_4065981088f8ef67a504ba8bd6b24d85
	RejectReason *string `query:"reject_reason" json:"-"` // 当修改版本状态为被驳回时, 这一项必填示例值: 拒绝理由
	Status       *int64  `json:"status,omitempty"`        // 版本状态示例值: 1可选值有: 未知状态审核通过审核拒绝审核中未提交审核
}
