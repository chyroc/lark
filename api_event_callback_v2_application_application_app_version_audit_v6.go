...
type EventV2ApplicationApplicationAppVersionAuditV6 struct {
	...
	AppID       string                                                    `json:"app_id,omitempty"`       // 审核应用的 id
	Operation   string                                                    `json:"operation,omitempty"`    // 审核通过 / 拒绝可选值有: 审核通过审核拒绝
	Remark      string                                                    `json:"remark,omitempty"`       // 审核信息, 当审核拒绝时, 管理员填写的拒绝理由
	AuditSource string                                                    `json:"audit_source,omitempty"` // 应用审核的方式可选值有: 管理员审核自动免审
}
...
// EventV2ApplicationApplicationAppVersionAuditV6Resp ...
type EventV2ApplicationApplicationAppVersionAuditV6Resp struct {
}
...
type eventV2ApplicationApplicationAppVersionAuditV6Resp struct {
	...
	Data  *EventV2ApplicationApplicationAppVersionAuditV6Resp `json:"data,omitempty"`
