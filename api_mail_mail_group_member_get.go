...
// new doc: https://open.feishu.cn/document/server-docs/mail-v1/mail-group/mailgroup-member/get
...
type GetMailGroupMemberReq struct {
	...
	MemberID         string            `path:"member_id" json:"-"`           // 邮件组内成员唯一标识示例值: "xxxxxxxxxxxxxxx"
