...
type DeleteDriveFileVersionReq struct {
	FileToken  string  `path:"file_token" json:"-"`    // 版本文档token, 示例值: "doxbcyvqZlSc9WlHvQMlSJwUrsb"
	VersionID  string  `path:"version_id" json:"-"`    // 版本文档版本号, 示例值: "file_version"
	ObjType    string  `query:"obj_type" json:"-"`     // 文档类型, 示例值: "doc/docs/sheet/bitable", 可选值有: doc: doc文档, sheet: sheet文档, bitable: bitable文档, docx: docx文档
