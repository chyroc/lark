...
// DeleteDriveFileVersion 删除基于在线文档或电子表格创建的版本。
//
...
type DeleteDriveFileVersionReq struct {
	FileToken  string  `path:"file_token" json:"-"`    // 当前版本对应的源文档的 token。获取方式参考[如何获取云文档相关 token](https://open.feishu.cn/document/ukTMukTMukTM/uczNzUjL3czM14yN3MTN#08bb5df6)。示例值: "doxbcyvqZlSc9WlHvQMlSJabcef"
	VersionID  string  `path:"version_id" json:"-"`    // 版本文档版本标识示例值: "fnJfyX"
