...
// new doc: https://open.feishu.cn/document/ai/document_ai-v1/chinese_passport/recognize
...
type RecognizeAIChinesePassportReq struct {
	File io.Reader `json:"file,omitempty"` // 识别的中国护照源文件示例值: file binary
}
...
type RecognizeAIChinesePassportRespChinesePassportEntitie struct {
	Type  string `json:"type,omitempty"`  // 识别的字段种类可选值有: 中文姓名英文格式姓名出生日期有效期至签发地点护照号码
