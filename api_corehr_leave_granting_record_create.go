...
// CreateCoreHrLeaveGrantingRecord 向飞书人事休假系统写入假期授予记录。
//
...
type CreateCoreHrLeaveGrantingRecordReq struct {
	...
	GrantingQuantity string                                      `json:"granting_quantity,omitempty"` // 授予数量, 示例值: "0.5"
	GrantingUnit     int64                                       `json:"granting_unit,omitempty"`     // 授予时长单位, 可选值有: 1: 天, 2: 小时, 示例值: 1
	EffectiveDate    string                                      `json:"effective_date,omitempty"`    // 生效时间, 示例值: "2022-01-01"
	Reason           []*CreateCoreHrLeaveGrantingRecordReqReason `json:"reason,omitempty"`            // 授予原因
...
type CreateCoreHrLeaveGrantingRecordResp struct {
	LeaveGrantingRecord *CreateCoreHrLeaveGrantingRecordRespLeaveGrantingRecord `json:"leave_granting_record,omitempty"` // 假期授予记录
}
...
type CreateCoreHrLeaveGrantingRecordRespLeaveGrantingRecord struct {
	...
	GrantingUnit     int64                                                           `json:"granting_unit,omitempty"`     // 授予时长单位, 可选值有: 1: 天, 2: 小时
	...
	GrantedBy        int64                                                           `json:"granted_by,omitempty"`        // 授予来源, 可选值有: 1: 系统授予, 2: 手动授予, 3: 外部系统授予
	Reason           []*CreateCoreHrLeaveGrantingRecordRespLeaveGrantingRecordReason `json:"reason,omitempty"`            // 授予原因
