...
func (r *VCService) BatchGetVCRoom(ctx context.Context, request *BatchGetVCRoomReq, options ...MethodOptionFunc) (*BatchGetVCRoomResp, *Response, error) {
	if r.cli.mock.mockVCBatchGetVCRoom != nil {
		...
		return r.cli.mock.mockVCBatchGetVCRoom(ctx, request, options...)
	}
	...
	req := &RawRequestReq{
		...
		API:                   "BatchGetVCRoom",
		Method:                "POST",
		URL:                   r.cli.openBaseURL + "/open-apis/vc/v1/rooms/mget",
		Body:                  request,
		MethodOption:          newMethodOption(options),
		NeedTenantAccessToken: true,
		NeedUserAccessToken:   true,
	}
	resp := new(batchGetVCRoomResp)

	response, err := r.cli.RawRequest(ctx, req, resp)
	return resp.Data, response, err
}

// MockVCBatchGetVCRoom mock VCBatchGetVCRoom method
func (r *Mock) MockVCBatchGetVCRoom(f func(ctx context.Context, request *BatchGetVCRoomReq, options ...MethodOptionFunc) (*BatchGetVCRoomResp, *Response, error)) {
	r.mockVCBatchGetVCRoom = f
}

// UnMockVCBatchGetVCRoom un-mock VCBatchGetVCRoom method
func (r *Mock) UnMockVCBatchGetVCRoom() {
	r.mockVCBatchGetVCRoom = nil
}

// BatchGetVCRoomReq ...
type BatchGetVCRoomReq struct {
	...
	RoomIDs    []string `json:"room_ids,omitempty"`     // 会议室id列表, 示例值: ["omm_4de32cf10a4358788ff4e09e37ebbf9b", "omm_3c5dd7e09bac0c1758fcf9511bd1a771"]
}

// BatchGetVCRoomResp ...
type BatchGetVCRoomResp struct {
	Items []*BatchGetVCRoomRespItem `json:"items,omitempty"` // 会议室列表
}

// BatchGetVCRoomRespItem ...
type BatchGetVCRoomRespItem struct {
	...
	RoomStatus   *BatchGetVCRoomRespItemRoomStatus `json:"room_status,omitempty"`    // 会议室状态
	Device       []*BatchGetVCRoomRespItemDevice   `json:"device,omitempty"`         // 设施信息列表
}

// BatchGetVCRoomRespItemDevice ...
type BatchGetVCRoomRespItemDevice struct {
	Name string `json:"name,omitempty"` // 设施名称
}

// BatchGetVCRoomRespItemRoomStatus ...
type BatchGetVCRoomRespItemRoomStatus struct {
...
type batchGetVCRoomResp struct {
	...
	Data *BatchGetVCRoomResp `json:"data,omitempty"`
}
