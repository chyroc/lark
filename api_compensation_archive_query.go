...
// QueryCompensationArchive 批量查询员工薪资档案
//
...
// 
func (r *CompensationService) QueryCompensationArchive(ctx context.Context, request *QueryCompensationArchiveReq, options ...MethodOptionFunc) (*QueryCompensationArchiveResp, *Response, error) {
if r.cli.mock.mockCompensationQueryCompensationArchive != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] Compensation#QueryCompensationArchive mock enable")
		return r.cli.mock.mockCompensationQueryCompensationArchive(ctx, request, options...)
	}

	req := &RawRequestReq{
		Scope:                 "Compensation",
		API:                   "QueryCompensationArchive",
		Method:                "POST",
 ...
 NeedUserAccessToken: true,
	...
	resp := new(queryCompensationArchiveResp)

	response, err := r.cli.RawRequest(ctx, req, resp)
	return resp.Data, response, err
}

// MockCompensationQueryCompensationArchive mock CompensationQueryCompensationArchive method
func (r *Mock) MockCompensationQueryCompensationArchive(f func(ctx context.Context, request *QueryCompensationArchiveReq, options ...MethodOptionFunc) (*QueryCompensationArchiveResp, *Response, error)) {
	r.mockCompensationQueryCompensationArchive = f
}
// UnMockCompensationQueryCompensationArchive un-mock CompensationQueryCompensationArchive method
func (r *Mock) UnMockCompensationQueryCompensationArchive() {
	r.mockCompensationQueryCompensationArchive = nil
}


// QueryCompensationArchiveReq ...
type QueryCompensationArchiveReq struct { 
...
// QueryCompensationArchiveResp ...
type QueryCompensationArchiveResp struct { 
Items []*QueryCompensationArchiveRespItem `json:"items,omitempty"` // 档案信息列表
...
// QueryCompensationArchiveRespItem ...
type QueryCompensationArchiveRespItem struct { 
...
ArchiveItems []*QueryCompensationArchiveRespItemArchiveItem `json:"archive_items,omitempty"` // 档案关联的薪资项字段权限要求: 获取薪资档案的关联薪资项
ArchiveIndicators []*QueryCompensationArchiveRespItemArchiveIndicator `json:"archive_indicators,omitempty"` // 档案关联的薪资指标字段权限要求: 获取薪资档案的关联薪资指标
}
...
// QueryCompensationArchiveRespItemArchiveIndicator ...
type QueryCompensationArchiveRespItemArchiveIndicator struct { 
...
// QueryCompensationArchiveRespItemArchiveItem ...
type QueryCompensationArchiveRespItemArchiveItem struct { 
...
Data *QueryCompensationArchiveResp `json:"data,omitempty"` 
