...
// new doc: https://open.feishu.cn/document/docs/wiki-v2/space-member/list
func (r *DriveService) ListWikiSpaceMember(ctx context.Context, request *ListWikiSpaceMemberReq, options ...MethodOptionFunc) (*ListWikiSpaceMemberResp, *Response, error) {
	if r.cli.mock.mockDriveListWikiSpaceMember != nil {
		r.cli.Log(ctx, LogLevelDebug, "[lark] Drive#ListWikiSpaceMember mock enable")
		return r.cli.mock.mockDriveListWikiSpaceMember(ctx, request, options...)
	}
...
// MockDriveListWikiSpaceMember mock DriveListWikiSpaceMember method
func (r *Mock) MockDriveListWikiSpaceMember(f func(ctx context.Context, request *ListWikiSpaceMemberReq, options ...MethodOptionFunc) (*ListWikiSpaceMemberResp, *Response, error)) {
	r.mockDriveListWikiSpaceMember = f
}

// UnMockDriveListWikiSpaceMember un-mock DriveListWikiSpaceMember method
func (r *Mock) UnMockDriveListWikiSpaceMember() {
	r.mockDriveListWikiSpaceMember = nil
}
